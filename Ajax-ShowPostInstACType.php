...
?>
                 ...
                 <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">First Name</label>
                  <div class="col-sm-7">
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Last Name</label>
                  <div class="col-sm-7">
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Gender</label>
                  <div class="col-sm-7">
...
?>
                ...
                <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Date of Birth</label>
                  <div class="col-sm-7">
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Email Address</label>
                  <div class="col-sm-7">
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Mobile Number</label>
                  <div class="col-sm-7">
                  <input name="phone" type="text" class="form-control" id="vbphone" onkeyup="veryBPhone();" value="+234" placeholder="+2348111111111" required>
                  <div id="myvphone"></div>
                  </div>
                  <label for="" class="col-sm-2 control-label"></label>
                  </div>
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Username</label>
                  <div class="col-sm-7">
				 ...
				 <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Password</label>
                  <div class="col-sm-7">
                  ...
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;"></label>
                  <div class="col-sm-7">
        ...
        <div class="form-group" align="right">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;"></label>
                  <div class="col-sm-7">
                  <button name="register" type="submit" class="btn bg-<?php echo ($mysendid != "") ? 'black' : 'blue'; ?> btn-flat"><i class="fa fa-cloud-upload">&nbsp;Register</i></button>
                  </div>
                  <label for="" class="col-sm-2 control-label"></label>
                  </div>
...
elseif($PostType == "Activate"){
?>
                    
                  <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;">Username</label>
                  <div class="col-sm-7">
                  <input name="username" type="username" class="form-control" placeholder="Your Username" required>
                  </div>
                  <label for="" class="col-sm-2 control-label"></label>
                  </div>
                  ...
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($mysendid != "") ? 'black' : 'blue'; ?>;"></label>
                  <div class="col-sm-7">
                  <button name="activate" type="submit" class="btn bg-<?php echo ($mysendid != "") ? 'black' : 'blue'; ?> btn-flat"><i class="fa fa-cloud-upload">&nbsp; Activate </i></button>
                  </div>
                  <label for="" class="col-sm-2 control-label"></label>
                  </div>
...
?>
            ...
            <?php } ?>
                ...
                <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($ussdcode == "0") ? 'black' : 'blue'; ?>;">Contact Person</label>
                  <div class="col-sm-7">
