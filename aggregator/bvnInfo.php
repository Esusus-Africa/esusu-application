...
<head>
  ...
  <?php
$call = mysqli_query($link, "SELECT * FROM member_settings WHERE companyid = '$aggmerchant'");
...
<?php }}?>
  ...
  <title><?php echo $fetch_aggrcurrency['cname']; ?></title>
...
?>
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="alert bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>" align="center">
                  <img src="<?php echo $fetchsys_config['file_baseurl']; ?>bvn_logo.png" width="200px" height="75px"/>
            </div>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fa fa-globe"></i> <?php echo strtoupper($fetch_aggrcurrency['cname']); ?>
              ...
              <div class="row invoice-info" style="border-style: none inset solid inset;">
                <div class="box box-widget widget-user">
                    ...
                    <address>
                        <img src="<?php echo ($num_bvn == 1 && $parameter[20] != '') ? $fetchsys_config['file_baseurl'].$parameter[20] : $fetchsys_config['file_baseurl'].'image-placeholder.jpg'; ?>" class="img-circle" width="150px" height="150px"/>
                    </address>
                    </div>
                    </div>
                </div>
