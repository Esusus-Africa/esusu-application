...
<!-- START -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input name="my_amount" type="text" class="form-control" placeholder="Enter Amount (Minimum: 1000 & Maximum: 50000)" max-length="5" required>
	    ...
	    ?>
	        <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:blue;">Payment Type:</label>
                <div class="col-sm-6">
	    ...
	    <div class="form-group" align="right">
                ...
                <div class="col-sm-6">
                    <button name="ValidateC1" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-mobile">&nbsp;Pay Bills</i></button>
                </div>
                <label for="" class="col-sm-3 control-label"></label>
        </div>
...
if(isset($_POST['ValidateC1']))
{
    ...
    if($aggwallet_balance < $my_amount){
        ...
        $commission = $jsonData2['discounted_amount'] * $billPaymentCommission;
        ...
        if($jsonData2['response'] == "OK"){
            ...
            $remainBalance = $aggwallet_balance - $jsonData2['discounted_amount'];
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$smart_card','','$discounted_amount','Debit','$aggcurrency','$mypayment_type - WEB','$service_msg','successful','$currentDateTime','$aggr_id','$remainBalance','')");
    		...
    		mysqli_query($link, "UPDATE user SET transfer_balance = '$remainBalance' WHERE id = '$aggr_id'");
            
            mysqli_query($link, "DELETE FROM bill_payverification WHERE refid = '$myref'");
        	echo "<script>alert('".$jsonData2['message']."\\n ".$service_msg."'); </script>";
        	//echo "<script>window.open('../pdf/view/pdf_payschedule.php?id=".$id."&&acn=".$tid."&&mid=NDA1&&lid=".$lid."&&instid=".."', '_blank'); </script>";
        	echo "<script>window.location='mywallet.php?id=".$_SESSION['tid']."&&mid=NDA0'; </script>";
...
?>
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:blue;">Product Plan:</label>
                <div class="col-sm-6">
	        ...
	        <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:blue;">Amount:</label>
                <div class="col-sm-6">
                    <input name="my_amount" type="text" class="form-control" placeholder="Enter Amount" max-length="5" required>
	    ...
	    <div class="form-group" align="right">
                <label for="" class="col-sm-3 control-label" style="color:blue;"></label>
                <div class="col-sm-6">
                    <button name="ValidateC2" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-mobile">&nbsp;Pay Bills</i></button>
                </div>
                <label for="" class="col-sm-3 control-label"></label>
        </div>
...
if(isset($_POST['ValidateC2']))
{
    ...
    if($aggwallet_balance < $my_amount){
        ...
        //$commission = $jsonData3['discounted_amount'] * $billPaymentCommission;
        ...
        if($jsonData3['response'] == "OK"){
            ...
            $remainBalance = $aggwallet_balance - $discounted_amount;
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$smart_card','','$discounted_amount','Debit','$aggcurrency','$categories - WEB','$service_msg','successful','$currentDateTime','$aggr_id','$remainBalance','')");
...
?>
	   ...
	   <div class="form-group" align="right">
           <label for="" class="col-sm-3 control-label" style="color:blue;"></label>
           <div class="col-sm-6">
           <button name="ValidateC" type="submit" class="btn bg-blue"><i class="fa fa-mobile">&nbsp;Validate</i></button>
           </div>
           <label for="" class="col-sm-3 control-label"></label>
        </div>
