<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDA0"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-user"></i>  Add Transfer Recipient</h3>
            </div>
...
if(isset($_POST['save']))
{
  ...
  if($result['status'] == "success"){
      ...
      $insert = mysqli_query($link, "INSERT INTO transfer_recipient VALUES(null,'$aggr_id','$recipient_id','$fullname','$account_number','$bank_code','$bank_name',NOW())") or die ("Error: " . mysqli_error($link));
...
?>           
        ...
        <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:blue;">Account Holder</label></label>
                  <div class="col-sm-10">
                    <div id="act_numb"></div>
        </div>
        </div>
              ...
              <div class="box-footer">
                				<button name="save" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-plus">&nbsp;Add Recipient</i></button>
