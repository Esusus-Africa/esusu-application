	       ...
	       <div class="box-body">
			...
			<input name="branchid" type="hidden" class="form-control" value="<?php echo $rows->branchid; ?>">
				...
				<div class="form-group">
                  <div class="col-sm-6"><span style="color:blue;"><b>From</b></span><br>
                  ...
                  <div class="col-sm-6"><span style="color:blue;"><b>To</b></span><br>
...
$dto = $_GET['dto'];
//$spool_by = $_GET['spby'];
$select = mysqli_query($link, "SELECT * FROM sms_logs1 WHERE (company_id = '$aggr_id') AND (date_time BETWEEN '$dfrom' AND '$dto') ORDER BY id") or die (mysqli_error($link));
