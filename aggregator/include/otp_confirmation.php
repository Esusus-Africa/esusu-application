<div class="box-body">
     ...
     <div class="form-group">
         <label for="" class="col-sm-3 control-label" style="color:blue;"><?php echo (isset($_GET['otp'])) ? 'OTP Code' : 'Transaction Pin'; ?></label>
         <div class="col-sm-6">
 ...
 <div class="form-group" align="right">
     ...
     <div class="col-sm-6">
         <button name="confirm" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-unlock">&nbsp;Confirm</i></button>
     </div>
     <label for="" class="col-sm-3 control-label"></label>
 </div>