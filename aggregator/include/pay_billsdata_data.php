...
<!--- DATA BUNDLE FORM START HERE -->			 
             ...
             <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <button name="Verifybill2" type="submit" onclick="myFunction()" class="btn bg-blue btn-flat"><i class="fa fa-search">&nbsp;Verify</i></button>
                    </div>
                    <label for="" class="col-sm-3 control-label" align="left"></label>
                  </div>
...
?>
	        ...
	        <div class="form-group" align="right">
                <label for="" class="col-sm-3 control-label" style="color:blue;"></label>
                <div class="col-sm-6">
                    <button name="PayBill2" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-mobile">&nbsp;Buy Airtime</i></button>
                </div>
                <label for="" class="col-sm-3 control-label"></label>
             </div>
		...
		if($jsonData['failed'] == "0")
		{
		    foreach($jsonData['result'] as $newOutput){
		        ...
		        if($newOutput['response'] == "OK"){
        		    ...
        		    $insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$phone','','$amount','Debit','$aggcurrency','Databundle - WEB','$operator Databundle Purchase for $databundle_product with refid: $myref via WEB','successful','$datetime','$aggr_id','$senderBalance','')");
        		    
        		    $insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$phone','$commission','','Credit','$aggcurrency','Commission - WEB','$operator Databundle Purchase Commission for $databundle_product with refid: $myref via WEB','successful','$datetime','$aggr_id','$senderBalance','')");
        		    ...
        		    $insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$phone','','$amount','Debit','$aggcurrency','Databundle - WEB','$operator Databundle Purchase for $databundle_product with refid: $myref via WEB','pending','$datetime','$aggr_id','$aggwallet_balance','')");
        		    
        		    $insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$aggmerchant','$transaction_id','$phone','$commission','','Credit','$aggcurrency','Commission - WEB','$operator Databundle Purchase Commission for $databundle_product with refid: $myref via WEB','pending','$datetime','$aggr_id','$aggwallet_balance','')");
