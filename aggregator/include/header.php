...
<?php }}?>
  ...
  ?>
  <title><?php echo $row['title']; ?> - Aggregator Account</title>
...
var chart = AmCharts.makeChart( "chartdiv", {
  ...
  "dataProvider": [ {
    ...
    "country": "Approved",
    "visits": <?php 
			$call1 = mysqli_query($link, "SELECT * FROM loan_info WHERE status = 'Approved' AND branchid = '$revenue_id'");
    ...
    "country": "Disapproved",
    "visits": <?php 
			$call2 = mysqli_query($link, "SELECT * FROM loan_info WHERE status = 'Disapproved' AND branchid = '$revenue_id'");
    ...
    "country": "Pending",
    "visits": <?php 
			$call3 = mysqli_query($link, "SELECT * FROM loan_info WHERE status = 'Pending' AND branchid = '$revenue_id'");
    ...
    "country": "Completed",
    "visits": <?php 
			$call4 = mysqli_query($link, "SELECT * FROM loan_info WHERE upstatus = 'Completed' AND branchid = '$revenue_id'");
    ...
    "country": "Processing",
    "visits": <?php 
			$call5 = mysqli_query($link, "SELECT * FROM loan_info WHERE upstatus = 'Pending' AND branchid = '$revenue_id'");
    ...
    "country": "Request",
    "visits": <?php 
			$call6 = mysqli_query($link, "SELECT * FROM loan_info WHERE branchid = '$revenue_id'");
...
var chart1 = AmCharts.makeChart( "chartdiv1", {
  ...
  "dataProvider": [ {
    ...
    "value": 
	<?php
	$add=mysqli_query($link,'SELECT SUM(balance) from pay_schedule WHERE status = "UNPAID" AND branchid = "'.$revenue_id.'"');
    ...
    "value": 
	<?php
	$add=mysqli_query($link,'SELECT SUM(payment) from pay_schedule WHERE status = "PAID" AND branchid = "'.$revenue_id.'"');
...
var chart2 = AmCharts.makeChart( "chartdiv2", {
  ...
  "dataProvider": [ {
    ...
    "value": 
	<?php
	$add=mysqli_query($link,'SELECT SUM(amount) from transaction WHERE t_type = "Withdraw" AND branchid = "'.$revenue_id.'"');
  	while($row1= mysqli_fetch_array($add))
  	{
    ...
    "value": 
<?php
	$add=mysqli_query($link,'SELECT SUM(amount) from transaction WHERE t_type = "Deposit" AND branchid = "'.$revenue_id.'" OR t_type = "Transfer-Received" AND branchid = "'.$revenue_id.'"');
  	while($row2= mysqli_fetch_array($add))
  	{
...
var chart = AmCharts.makeChart("chartdiv7", {
	...
	$call7 = mysqli_query($link, "SELECT SUM(amount_to_pay), pay_date FROM payments WHERE branchid = '$revenue_id'");
	...
	$call7 = mysqli_query($link, "SELECT SUM(balance), pay_date FROM loan_info WHERE branchid = '$revenue_id' ORDER BY id DESC");
	$fetch = mysqli_fetch_array($call7);
	?>
        "year": "<?php echo date("Y", strtotime($fetch['pay_date'])); ?>",
...
function calcPrice()
  {
   ...
   var rquantity=document.getElementById("rquantity").value;
   
   if(product_rate && rquantity)
   {
    $.ajax({
    type: "POST",
    url: "calc_tprice.php",
    ...
    success: function(response) {
     // We get the element having id of display_info and put the response inside it
      //alert(response);
     $('#calcprice').html(response);
    }
    });
   }
   else
   {
    $('#calcprice').html("<label class='label label-danger'>Total Price Loading...</label>");
   }
  }
  </script>
...
?>
<body class="hold-transition skin-<?php echo $row['theme_color']; ?> sidebar-mini" onload="initialize()">
