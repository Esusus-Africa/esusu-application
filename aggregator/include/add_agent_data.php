   ...
   <section class="content">
     ...
     <div class="col-md-14">
            ...
            <ul class="nav nav-tabs">
             <li <?php echo ($_GET['tab'] == 'tab_1') ? "class='active'" : ''; ?>><a href="add_agent?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("440"); ?>&&tab=tab_1">Client Onboarding Form</a></li>
              </ul>
...
if(isset($_POST['save']))
{
  ...
  elseif($ResponseCode != "200" && $userBvn != ""){
    ...
    ($userBvn == "") ? "" : $imagePath = $image_converted;
    ...
    ($userBvn == "") ? "" : $insert = mysqli_query($link, "INSERT INTO bvn_log VALUE(null,'$institutionID','','$drID','$aggr_id','$mybvn_data','$bvn_fee','$date_time','$rOrderID')");
    ...
    ($userBvn == "") ? "" : $insert = mysqli_query($link, "INSERT INTO expenses VALUES(null,'','$rOrderID','BVN Verification','$bvn_fee','$date','$iname Contact Person BVN Verification Charges')");
		...
		$insert_institution = mysqli_query($link, "INSERT INTO institution_data VALUES(null,'$institutionID','NIL','$icat','$location','$iname','$license_no','$addrs','$state','$country','$official_email','$official_phone','$userBvn','$itype','Approved','Enable','0.0','$wprefund_bal','NULL','$date_time','$aggr_id','','')") or die ("Error: " . mysqli_error($link));
    ...
    $insert_institution = mysqli_query($link, "INSERT INTO maintenance_history VALUE(null,'$institutionID','2.5','','flat','7.5','1000','Activated','Hybrid','50','0','50','30','30','0','0','0.01','0.005','Flat','0','0','4','0','0')") or die ("Error: " . mysqli_error($link));
      ...
      $sendSMS->backendGeneralAlert($sys_abb, $official_phone, $sms, $sms_refid, $sms_charges, $aggr_id);
