...
function fetch_data()
{
    ...
    $acctno = $_GET['acctno'];
    $branch = $_GET['branch'];
	$sql = "SELECT * FROM transaction WHERE date_time BETWEEN '$dfrom' AND '$dto' AND t_type = '$ttype' AND (acctno = '$acctno' OR (branchid = '$merchant' AND sbranchid = '$branch')) ORDER BY id ASC";
