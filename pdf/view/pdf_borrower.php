...
function fetch_data()
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		$output .= '<tr>
						...
						<td align="center"><div style="color: orange;">'.$currency.number_format($row_sel_pay['sum(amount_to_pay)'],2,'.',',').'</div></td>
						<td align="center"><div style="color: orange;">'.$currency.number_format($row_pend['sum(payment)'],2,'.',',').'</div></td>
						<td align="center"><div style="color: orange;">'.$currency.number_format($get_amt,2,".",",").'</div></td>
						<td align="center"><div style="color: orange;"><b>'.$currency.number_format($rowbee['sum(amount_topay)'],2,".",",").'</b></div></td>
					</tr>
					';
	}
	return $output;
...
$row_sys = mysqli_fetch_array($sys);
	...
	<thead>
	 <tr>
        ...
        <th><div align="center"><b>Total Collections</b></div></th>
		<th><div align="center"><b>Pending Balance</b></div></th>
