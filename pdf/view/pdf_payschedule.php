...
$bname = $fetch_borrower['lname'].' '.$fetch_borrower['fname'];
	...
	$content = '
		...
		<div align="center"><h3><b style="font-size: 15px;">(Loan Repayment Schedule)</b></h3></div>
		...
		<table class="table table-bordered table-striped" width="100%" border="1">
	            <tr>
                  ...
                  <th><b>REPAYMENT STATUS:</b><br>'.$fetch_loan['p_status'].'</th>
                ...
                <tr>
                  ...
                  <th><b>LOAN TYPE:</b><br>'.$fetch_loan['loantype'].'</th>
				  <th><b>APPROVAL DATE:</b><br>'.(($fetch_loan['date_release'] == "") ? "----" : $fetch_loan['date_release']).'</th>
                  <th><b>CUSTOMER NAME:</b><br>'.$bname.' ('.$fetch_loan['baccount'].')</th>
                  <th><b>LOAN ID:</b><br>'.$fetch_loan['lid'].'</th>
                </tr>';
    $content .= '</tbody></table>
	<table class="table table-bordered table-striped" width="100%" border="1">
			  	<tr>
