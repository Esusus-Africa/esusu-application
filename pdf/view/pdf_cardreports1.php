...
$protocol = ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://";
	...
	$content = '
		<div align="center"><img src="'.($logo != "img/" || $logo != "" ? $protocol.$_SERVER['HTTP_HOST'].'/'.$logo : $protocol.$_SERVER['HTTP_HOST'].'/img/esusuafrica 3.png').'" width="80" height="80" class="user-image" alt="User Image">
		<div align="center"><h3><b style="font-size:20;">'.($cname == "" ? $row_sys['name'] : $cname).'</b></h3></div>
