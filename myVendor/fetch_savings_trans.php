...
$column = array('id', 'Invoice Code', 'Agent Name', 'Customer Name', 'Plan Name', 'Subscription Code', 'Reference No.', 'Amount', 'Date/Time');
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy != "all" && $filterBy != "pending" && $filterBy != "successful"){
    ...
    WHERE date_time BETWEEN '$startDate' AND '$endDate' AND merchant_id = '$vcreated_by' AND vendorid = '$vendorid' AND (agentid = '$filterBy' OR acn = '$filterBy')
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all"){
    ...
    $query .= "SELECT * FROM all_savingssub_transaction 
    WHERE date_time BETWEEN '$startDate' AND '$endDate' AND merchant_id = '$vcreated_by' AND vendorid = '$vendorid'
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "pending"){
    ...
    $query .= "SELECT * FROM all_savingssub_transaction 
    WHERE date_time BETWEEN '$startDate' AND '$endDate' AND merchant_id = '$vcreated_by' AND vendorid = '$vendorid' AND status = 'pending'
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "successful"){
    ...
    $query .= "SELECT * FROM all_savingssub_transaction 
    WHERE date_time BETWEEN '$startDate' AND '$endDate' AND merchant_id = '$vcreated_by' AND vendorid = '$vendorid' AND status = 'successful'
    ";
...
{
 $query = "SELECT * FROM all_savingssub_transaction WHERE merchant_id = '$vcreated_by' AND vendorid = '$vendorid'";
 $statement = $connect->prepare($query);
 $statement->execute();
