<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="sms_marketing.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NzYw"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-area-chart"></i>  Report</h3>
            </div>

             <div class="box-body">
			 
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
			 <div class="alert bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"> The SMS delivery report shows the <b>sender id, the recipient phone number, status with date and time</b>. </div>
             <div class="box-body">
...
<hr>
<div align="left" style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"> <h4><b>SMS Delivery Reports From <?php echo $_GET['dfrom']; ?> - <?php echo $_GET['dto']; ?></b> (change dates above)</h4> </div>
<br>
...
$dto = $_GET['dto'];
//$spool_by = $_GET['spby'];
$select = mysqli_query($link, "SELECT * FROM sms_logs1 WHERE (company_id = '$vendorid') AND (date_time BETWEEN '$dfrom' AND '$dto') ORDER BY id") or die (mysqli_error($link));
