...
<div class="col-md-14">
            ...
            <ul class="nav nav-tabs">
                <?php
                $search_notify1 = mysqli_query($link, "SELECT * FROM investment_notification WHERE vendorid = '$vendorid' AND status = 'Pending' ORDER BY id DESC");
                $num_notify1 = mysqli_num_rows($search_notify1);

                $search_notify2 = mysqli_query($link, "SELECT * FROM investment_notification WHERE vendorid = '$vendorid' AND status = 'Approved' ORDER BY id DESC");
                $num_notify2 = mysqli_num_rows($search_notify2);

                $search_notify3 = mysqli_query($link, "SELECT * FROM investment_notification WHERE vendorid = '$vendorid' AND status = 'Declined' ORDER BY id DESC");
