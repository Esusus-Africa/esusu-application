...
if(isset($_POST['ValidateC1']))
{
    ...
    if($vwallet_balance < $my_amount){
        ...
        $commission = $jsonData2['discounted_amount'] * $vbillPaymentCommission;
        ...
        if($jsonData2['response'] == "OK"){
            ...
            $remainBalance = $vwallet_balance - $jsonData2['discounted_amount'];
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$vcreated_by','$transaction_id','$smart_card','','$discounted_amount','Debit','$vcurrency','$mypayment_type - WEB','$service_msg','successful','$currenctdate','$vuid','$remainBalance','')");
    		...
    		mysqli_query($link, "UPDATE vendor_reg SET wallet_balance = '$remainBalance' WHERE companyid = '$vendorid'");
...
if(isset($_POST['ValidateC2']))
{
    ...
    if($vwallet_balance < $my_amount){
        ...
        //$commission = $jsonData3['discounted_amount'] * $vbillPaymentCommission;
        ...
        if($jsonData3['response'] == "OK"){
            ...
            $remainBalance = $vwallet_balance - $discounted_amount;
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$vcreated_by','$transaction_id','$smart_card','','$discounted_amount','Debit','$vcurrency','$categories - WEB','$service_msg','successful','$currenctdate','$vuid','$remainBalance','')");
