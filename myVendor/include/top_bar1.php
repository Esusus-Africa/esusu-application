...
<?php } ?>
      ...
      {
      ?>
              <img src="../<?php echo ($row['image'] == '' || $row['image'] == 'img/') ? 'image/avatar.png' : $row['image']; ?>" class="user-image" alt="User Image">
          ...
          <span class="hidden-xs"><?php echo $row ['name'] ;?></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="../<?php echo ($row['image'] == '' || $row['image'] == 'img/') ? 'image/avatar.png' : $row['image']; ?>" class="img-circle" alt="User Image">
                <p>
          ...
          <?php }}?>
              ...
              <?php echo '<b style="font-size: 16px;">'.((mysqli_num_rows($vsearch_maintenance_model) == 1) ? "": $vsub_token).'</b>'; ?>
