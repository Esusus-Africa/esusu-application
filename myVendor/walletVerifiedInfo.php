            ...
            <p><b>GOVERNMENT ISSUED ID</b></p>
                    ...
                    if(mysqli_num_rows($search_file) == 0){
                    	...
                    	while($get_file = mysqli_fetch_array($search_file)){
                    		$i++;
                    ?>
                    <a href="<?php echo $fetchsys_config['file_baseurl'].$get_file['attached_file']; ?>" target="_blank"><img src="<?php echo $fetchsys_config['file_baseurl']; ?>file_attached.png" width="64" height="64"> <?php echo $get_file['file_title']; ?></a>
                    <?php
                    	}
                    }
                    ?>
                  ...
                  ?>
                  <hr>
                  <p><b>DOWNLOAD CUSTOMER KYC</b></p>

                  <a href="downloadCustInfo.php?id=<?php echo $_SESSION['tid']; ?>&&acct=<?php echo $_GET['uid']; ?>&&scode=<?php echo $_GET['scode']; ?>&&export"><img src="../img/file_attached.png" width="64" height="64"> Download KYC</a>
                  
                  <hr>
                  <p><b>POLICY DOCUMENT / INVESTMENT CERTIFICATE</b></p>
                  <?php
                    $i = 0;
