...
$postdata =  array(
              "From"          => $r->email_from,
              "To"            => $emapData[7],  //Cooperative Member Email Address
              "TemplateId"    => '9572344',
              "TemplateModel" => [
                "product_name"      => $r->name,
                "name"              => $emapData[5],  //Cooperative Member Name
                "memberid"          => $coopmemberID, //Coop Member ID
                "product_url"       => $r->website,
                "user_id"           => $emapData[7], //Cooperative Member Email
                "password"          => $emapData[9], //Cooperative Member Password
                "logo_url"          => $r->logo_url,
