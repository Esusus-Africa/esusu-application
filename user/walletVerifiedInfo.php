            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info" style="border-style: none inset solid inset;">
                <div class="box box-widget widget-user">
                    ...
                    <address>
                        <img src="../<?php echo ($num_bvn == 1 && $parameter[20] != '') ? 'img/'.$parameter[20] : 'img/image-placeholder.jpg'; ?>" class="img-circle" width="150" height="150"/>
                    </address>
                    </div>
                    </div>
                </div>
                  ...
                  <?php
                    ...
                    if(mysqli_num_rows($search_file) == 0){
                    	...
                    	while($get_file = mysqli_fetch_array($search_file)){
                    		$i++;
                    ?>
                    <a href="../application/<?php echo $get_file['attached_file']; ?>" target="_blank"><img src="../img/file_attached.png" width="64" height="64"> <?php echo $get_file['doc_type']; ?><?php echo $i; ?></a>
                    <?php
                    	}
                    }
                    ?>
