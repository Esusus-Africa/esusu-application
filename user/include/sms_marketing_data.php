<div class="box">
            ...
            echo "<span id='smsunit_balance'>".number_format(($bwallet_balance/$fetchsys_config['fax']),2,'.',',')." Unit(s) of sms </span>";
            ?> 
            </strong>
              </button>
	...
	if (isset($_POST['send_sms']))
	{
	    ...
	    if($my_cat == "Group"){
            ...
            while(!feof($open)) 
            {
            	...
            	$qry = mysqli_query($link, "INSERT INTO sms_logs1(id,company_id,c_type,sender_id,recipient,sms_content,sms_status,date_time) VALUES(null,'$acctno','agent','$sys_abb','$phone_file','$sms','Pending',NOW())");
	    ...
	    elseif($my_cat == "Personalize"){
	        ...
	        for($i = 0; $i < $length; $i++){
                ...
                $qry = mysqli_query($link, "INSERT INTO sms_logs1(id,company_id,c_type,sender_id,recipient,sms_content,sms_status,date_time) VALUES(null,'$acctno','agent','$sys_abb','$str_arr[$i]','$sms','Pending',NOW())");
	        ...
	        $qry = mysqli_query($link, "INSERT INTO sms_logs1(id,company_id,c_type,sender_id,recipient,sms_content,sms_status,date_time) VALUES(null,'$acctno','agent','$sys_abb','$my_cat','$sms','Pending',NOW())");
