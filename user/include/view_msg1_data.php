<div class="box">
            ...
            <h3 class="panel-title"> <a href="inboxmessage.php?id=<?php echo $_SESSION['tid']; ?>&&acn=<?php echo $_SESSION['acctno']; ?>&&mid=<?php echo base64_encode('406'); ?>"><i class="fa fa-reply-all"></i></a> Reply Ticket (Closed)</h3>
            </div>
             <div class="box-body">
		  <hr>
<?php
