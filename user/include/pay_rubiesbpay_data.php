...
if(isset($_POST['PayBill1']))
{
    ...
    if($my_amount <= 0){
        ...
        $dataToProcess = $reference."|".$my_amount."|".$customerid."|".$phone."|".$bwallet_balance."|".$pcode."|".$cust_name."|".$billercode;
        ...
        ($bwallet_balance < $my_amount) ? "" : $rubbies_generate = json_decode($response, true);
