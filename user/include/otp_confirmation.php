<div class="box-body">
     ...
     <div align="center"><img src="<?php echo $fetchsys_config['file_baseurl']; ?>otp_image.jpg" height="200" width="300"/></div>
 ...
 <div class="form-group" align="right">
     ...
     <div class="col-sm-6">
         <button name="confirm" type="submit" onclick="var e=this;setTimeout(function(){e.disabled=true;},0);return true;" class="btn bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?> btn-flat"><i class="fa fa-unlock">&nbsp;Confirm</i></button>
     </div>
     <label for="" class="col-sm-3 control-label"></label>
 </div>