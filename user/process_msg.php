...
$insert = mysqli_query($link, "INSERT INTO message VALUES(null,'$ticketid','$acctno','$bname','$bbranchid','$subject','$message','Pending','$bsbranchid',NOW())") or die (mysqli_error($link));
if(!$insert)
{
