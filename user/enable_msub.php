...
$s_num = mysqli_num_rows($select_rave);
...
if($result['status'] == "success"){
	...
	echo '<meta http-equiv="refresh" content="2;url=view_msaving_sub.php?tid='.$_SESSION['tid'].'&&mid='.((isset($_GET['Takaful'])) ? 'NTA0' : ((isset($_GET['Savings'])) ? 'NTAw' : 'NDA3')).''.((isset($_GET['Takaful'])) ? '&&Takaful' : ((isset($_GET['Health'])) ? '&&Health' : ((isset($_GET['Savings'])) ? '&&Savings' : ''))).'">';
	echo '<br>';
