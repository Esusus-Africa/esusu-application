...
$search_pendtransact = mysqli_query($link, "SELECT * FROM fund_allocation_history WHERE status = 'pendingtill' AND paymenttype = 'MNFY'");
while($fetch_pendtransact = mysqli_fetch_array($search_pendtransact))
{
    ...
    $paymentref1 = urlencode($fetch_pendtransact['txid']);
