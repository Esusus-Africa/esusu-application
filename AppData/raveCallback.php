...
$search_pendtransact = mysqli_query($link, "SELECT * FROM wallet_history WHERE status = 'pending' AND paymenttype = 'WEMA'");
while($fetch_pendtransact = mysqli_fetch_array($search_pendtransact))
{
    ...
    if ($err) {
      ...
      if($transaction['data']['status'] == "successful" && $initiator == ""){
          ...
          mysqli_query($link, "UPDATE wallet_history SET recipient = '$bankdetails', paymenttype = '$paymentMethod', currency = '$currencyCode', remark = '$sms', status = 'successful', balance = '$total_iwallet_bal' WHERE refid = '$paymentref' AND status = 'pending'");
      ...
      if($transaction['data']['status'] == "successful" && startsWith($initiator,"VEND")){
          ...
          mysqli_query($link, "UPDATE wallet_history SET recipient = '$bankdetails', paymenttype = '$paymentMethod', currency = '$currencyCode', remark = '$sms', status = 'successful', balance = '$total_vwallet_bal' WHERE refid = '$paymentref' AND status = 'pending'");
    ...
    /*if($transaction->responseBody->paymentStatus == "PAID" && startsWith($recipient,"COOP")){
      ...
      if($transaction['data']['status'] == "successful" && (startsWith($initiator,"MEM") || startsWith($initiator,"Loan=") || startsWith($initiator,"AGGR"))){
          ...
          mysqli_query($link, "UPDATE wallet_history SET recipient = '$bankdetails', paymenttype = '$paymentMethod', currency = '$currencyCode', remark = '$sms', status = 'successful', balance = '$total_cwallet_bal' WHERE refid = '$paymentref' AND status = 'pending'");
      ...
      if($transaction['data']['status'] == "successful" && $initiator != "" && !(startsWith($initiator,"VEND")) && !(startsWith($recipient,"COOP")) && !(startsWith($initiator,"MEM")) && !(startsWith($initiator,"Loan=") && !(startsWith($initiator,"AGGR")))){
          ...
          mysqli_query($link, "UPDATE wallet_history SET recipient = '$bankdetails', paymenttype = '$paymentMethod', currency = '$currencyCode', remark = '$sms', status = 'successful', balance = '$total_bwallet_bal' WHERE refid = '$paymentref' AND status = 'pending'");
