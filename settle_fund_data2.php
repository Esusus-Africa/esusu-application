...
?>           
            ...
            <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Amount in Cashier Till</label>
                  <div class="col-sm-9">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9">
				  <textarea name="note_comment"  class="form-control" rows="2" cols="80" placeholder="Note / Comment"></textarea>
                </div>
                </div>		  
