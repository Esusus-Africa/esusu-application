...
$instid = $_GET['instid'];
$call_memset = mysqli_query($link, "SELECT * FROM member_settings WHERE companyid = '$instid'");
...
<?php
echo '<meta http-equiv="refresh" content="2;url=institution/dashboard.php?id='.$_SESSION['tid'].'&&mid='.base64_encode('401').'">';
echo '<br>';
