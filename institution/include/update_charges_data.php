<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="view_charges.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NTIw"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-asterisk"></i>  Update Charges</h3>
            </div>
...
?>			 			
            ...
            <div class="form-group">
              ...
              <div class="box-footer">
                				<button name="save" type="submit" class="btn bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><i class="fa fa-save">&nbsp;Update</i></button>
              </div>
			  </div>
