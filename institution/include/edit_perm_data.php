...
<div class="box-body">
			...
			<div class="form-group">
				...
				<?php
					...
					{
					?>		
					<b style="color: orange;"><?php echo $get_users['name']; ?></b>
				<?php } ?>
                </div>			
            </div>
			<div class="form-group">
