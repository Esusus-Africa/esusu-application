<div class="box">
	       <div class="box-body">
			...
			?>
            <h3 class="panel-title"><i class="fa fa-money"></i> Customer Withdrawal Form | <b>Till Balance: -<?php echo number_format($balance,2,'.',','); ?></b>
...
{    
	...
	$mydata = $txid."|".$account."|".$ptype."|".$amount."|".$remark."|".$final_charges."|".$fn."|".$ln."|".$em."|".$ph."|".$bal."|".$uname."|".$lwdate."|".$overdraft."|".$acct_type."|".$maintenance_row."|".$t_perc."|".$sms_checker."|".$balLabel."|".$balanceToImpact."|".$branch;
...
{    
	...
	if($otpnum == 0){
		...
		if($final_charges != 0)
		{
			...
			$update = mysqli_query($link, "UPDATE till_account SET balance = '$remain_balance', unsettled_balance = '$totalUnsettledBal' WHERE cashier = '$iuid'");

			mysqli_query($link, "INSERT INTO fund_allocation_history VALUES(null,'$txid','$institution_id','$iuid','$isbranchid','$fullname','$iuid','$totalamount','Credit','$transactionType','$icurrency','$remain_balance','$remark','successful','$date_time')");
