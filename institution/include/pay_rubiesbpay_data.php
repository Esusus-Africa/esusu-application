...
if(isset($_POST['PayBill1']))
{
    ...
    if($my_amount <= 0){
        ...
        $dataToProcess = $reference."|".$my_amount."|".$customerid."|".$phone."|".$itransfer_balance."|".$pcode."|".$cust_name."|".$billercode;
        ...
        ($itransfer_balance < $my_amount) ? "" : $rubbies_generate = json_decode($response, true);

        if($rubbies_generate['responsecode'] == "00" && $itransfer_balance >= $my_amount){
