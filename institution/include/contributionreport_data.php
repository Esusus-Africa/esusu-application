<div class="box">
	       <div class="box-body">
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
			 <div class="alert bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"> The Contributions report shows the <b>Contributors Name, Email, Amount and Status</b>. </div>
             <div class="box-body">
...
?>				  
			...
			<input name="branchid" type="hidden" class="form-control" value="<?php echo $rows->branchid; ?>">
				...
				<div class="form-group">
                  <div class="col-sm-4"><span style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><b>From</b></span><br>
                  ...
                  <div class="col-sm-4"><span style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><b>To</b></span><br>
                  ...
                  <div class="col-sm-4"><span style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><b>Project Categories</b></span><br>
				  ...
				  <?php } ?>
					...
					<span style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;">Select the project categories</span>
                  </div>
                </div>
...
<hr>
<div align="right" style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"> <h4><b>From <?php echo $_GET['dfrom']; ?> - <?php echo $_GET['dto']; ?></b> (change dates above)</h4> </div>
<br>
