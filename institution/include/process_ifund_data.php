...
<?php
  echo "<span id='twallet_balance'>".$icurrency.number_format($itransfer_balance,2,'.',',')."</span>";
?> 
</strong>
  </button>
      ...
      <div class="tab-pane <?php echo ($_GET['tab'] == 'tab_6') ? 'active' : ''; ?>" id="tab_6">
       ...
       <form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input name="amt_totransfer" type="text" class="form-control" value="<?php echo number_format($amt_todisburse,2,'.',','); ?>" readonly>
                </div>
...
if(isset($_POST['savedb_save']))
{
    ...
    elseif($totalAmtToCharge > $itransfer_balance){
      ...
      echo "<div class='alert bg-orange'>Oops! You do not have enough fund in your transfer wallet!!</div>";
        ...
        $senderBalance = $itransfer_balance - $totalAmtToCharge;
        ...
        $update = mysqli_query($link, "UPDATE borrowers SET wallet_balance = '$receiverBalance' WHERE virtual_number = '$account'") or die (mysqli_error($link));
        $insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$institution_id','$txid','$virtual_acctno','$amountCredited','$icurrency','$ptype','$remark','successful','$final_date_time','$iuid','$itransfer_balance')") or die (mysqli_error($link));

        include("alert_sender/send_sp2ptransfer_alertemail.php");
        echo "<div align='center'><img src='../image/checkmark.gif'><p style='color: #38A1F3;'>Transaction Successful!</p>else</div>";
