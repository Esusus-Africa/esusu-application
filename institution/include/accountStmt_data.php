<div class="row">
            ...
            <div class="box-body">
             ...
             <div class="box-body">
<form method="post">
  <a href="accountStmt.php?id=<?php echo $_SESSION['tid']; ?>&&mid=OTIy&&tab=tab_1"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-refresh"></i>&nbsp;Refresh</button></a> 
</form>
  <hr>
  ...
  <div class="col-md-14">
            ...
            <ul class="nav nav-tabs">
             <li <?php echo ($_GET['tab'] == 'tab_1') ? "class='active'" : ''; ?>><a href="accountStmt.php?tid=<?php echo $_SESSION['tid']; ?>&&mid=OTIy&&tab=tab_1">Account Statement Report</a></li>
            </ul>
...
if(isset($_GET['tab']) == true)
{
  ...
  ?>
             ...
             <div class="box-body">
	            ...
	            <div class="form-group">
                  ...
                  <select name="ttype" id="transType" class="form-control select2" style="width:100%" required>
                    ...
                    <option disabled>Filter By Customer Account</option>
                    <?php
            ...
            <hr>
            <div class="table-responsive">
			    <table id="fetch_accountStmt_data" class="table table-bordered table-striped">
                <thead>
                <tr>
