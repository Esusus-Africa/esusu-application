<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="setuploanprd.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDEx"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-newspaper-o"></i>  Add Loan Product</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$penalty_type = mysqli_real_escape_string($link, $_POST['penalty_type']);
	$penalty_rate = mysqli_real_escape_string($link, $_POST['penalty_rate']);
		
	$insert = mysqli_query($link, "INSERT INTO loan_product VALUES(null,'$institution_id','$insti_subaccount_code','$cat','$pname','$interest_rate','$lduration','$tenor','No','0','','$interest_type','$idedicated_ussd_prefix','Pending','$penalty_type','$penalty_rate')") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
...
?>           
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>">Loan Type</label>
				 <div class="col-sm-9">
            ...
            <div class="form-group">
			  ...
			  <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>">Penalty Type</label>
				 <div class="col-sm-9">
                <select name="penalty_type" class="select2" style="width: 100%;" required>
				<option value="" selected="selected">--Penalty Type--</option>
			...
			<div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Penalty Rate</label>
                  <div class="col-sm-9">
                  <input name="penalty_rate" type="text" class="form-control" placeholder="Pernalty Rate" required>
                  </div>
                  </div>
