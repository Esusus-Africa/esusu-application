...
<?php } ?>
		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<option disabled>SELECT INDIVIDUAL AGENT</option>
				<?php
				$get = mysqli_query($link, "SELECT * FROM agent_data ORDER BY id") or die (mysqli_error($link));
	...
	if (isset($_POST['send_sms']))
	{
	    ...
	    if($cto == ""){
	    	...
	    	$gateway_pass = $fetch_gateway->gateway_password;
	    	$gateway_api = $fetch_gateway->gateway_api;

	      	$search_cmember = mysqli_query($link, "SELECT * FROM agent_data") or die("Error:" . mysqli_error($link));
