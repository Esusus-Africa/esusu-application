...
if(isset($_POST['ValidateC1']))
{
    ...
    if($itransfer_balance < $my_amount){
        ...
        $commission = $jsonData2['discounted_amount'] * $ibillPaymentCommission;
        ...
        if($jsonData2['response'] == "OK"){
            ...
            $remainBalance = $itransfer_balance - $jsonData2['discounted_amount'];
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$institution_id','$transaction_id','$smart_card','','$discounted_amount','Debit','$icurrency','$mypayment_type - WEB','$service_msg','successful','$currentDateTime','$iuid','$remainBalance','')");
    		...
    		mysqli_query($link, "UPDATE user SET transfer_balance = '$remainBalance' WHERE id = '$iuid'");
        	...
        	echo "<script>window.location='mywallet.php?id=".$_SESSION['tid']."&&mid=NDAx'; </script>";
...
if(isset($_POST['ValidateC2']))
{
    ...
    if($itransfer_balance < $my_amount){
        ...
        //$commission = $jsonData3['discounted_amount'] * $ibillPaymentCommission;
        ...
        if($jsonData3['response'] == "OK"){
            ...
            $remainBalance = $itransfer_balance - $discounted_amount;
    		...
    		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$institution_id','$transaction_id','$smart_card','','$discounted_amount','Debit','$icurrency','$categories - WEB','$service_msg','successful','$currentDateTime','$iuid','$remainBalance','')");
