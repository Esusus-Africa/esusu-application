...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO expenses VALUES(null,'$institution_id','$expID','$exptype','$eamt','$edate','$edesc')") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
...
Accepted file types <span style="color:<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>">jpg, gif, png, xls, xlsx, csv, doc, docx, pdf</span>
			 <input name="uploaded_file[]" type="file" class="btn bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>" multiple>
