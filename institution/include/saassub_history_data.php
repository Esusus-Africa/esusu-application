...
<form method="post">
	...
	<hr>		
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody> 
<?php
$select = mysqli_query($link, "SELECT * FROM saas_subscription_trans WHERE status = 'Paid' AND coopid_instid = '$institution_id' ORDER BY id DESC") or die (mysqli_error($link));
...
?> 
				...
				<td><?php echo number_format($row['sms_allocated'],2,'.',','); ?> SMS</td>
