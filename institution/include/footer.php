...
<footer class="main-footer">
	...
	<strong><?php echo ($icopyright == "") ? "Copyright ".date("Y").". Powered by Esusu Africa" : $icopyright; ?></strong>
  </footer>
...
function payrollAdd() {
   ...
   <script src="../plugins/bootstrap-slider/bootstrap-slider.js"></script>
 	...
 	<script>
     $('#loan_products1').change(function(){
         var PostType=$('#loan_products1').val();
         $.ajax({url:"Ajax-ShowPostLoanP1.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
 	</script>
 ...
 <script>
     $('#verification_type').change(function(){
         var PostType=$('#verification_type').val();
         $.ajax({url:"Ajax-VerificationType.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
 </script>
...
<script>
     $('#savings_interval').change(function(){
         var PostType=$('#savings_interval').val();
         $.ajax({url:"Ajax-MirrorInterval.php?PostType="+PostType,cache:false,success:function(result){
             $('#mirror_interval').html(result);
         }});
     });
</script>
...
<script>
     $('#account_topost_to').change(function(){
         var PostType=$('#account_topost_to').val();
         $.ajax({url:"Ajax-AccountPoster.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
</script>
...
<script>
     $('#lock_withdrawal').change(function(){
         var PostType=$('#lock_withdrawal').val();
         $.ajax({url:"Ajax-ShowLockWithdrawal.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank4').html(result);
         }});
     });
</script>
...
<script>
     $('#pinterval').change(function(){
         var PostType=$('#pinterval').val();
         $.ajax({url:"Ajax-ShowPInterval.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank6').html(result);
         }});
     });
</script>

<script>
     $('#part_withdrawal').change(function(){
         var PostType=$('#part_withdrawal').val();
         $.ajax({url:"Ajax-ShowPartWithdrawal.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank5').html(result);
         }});
     });
</script>
...
<script>
     $('#bankcat').change(function(){
         var PostType=$('#bankcat').val();
         $.ajax({url:"Ajax-ShowBankCat.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
</script>
...
<script>
    $('#withdrawfrom').change(function(){
        var PostType=$('#withdrawfrom').val();
        $.ajax({url:"Ajax-ShowWithdrawalSub.php?PostType="+PostType,cache:false,success:function(result){
            $('#ShowValueFrank').html(result);
        }});
    });
  </script>
  ...
  <script>
     $('#saas_subplan').change(function(){
         var PostType=$('#saas_subplan').val();
         $.ajax({url:"Ajax-ShowSubPlan.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
  </script>
...
<script>
    $('#evn_option').change(function(){
        var PostType=$('#evn_option').val();
        $.ajax({url:"Ajax-ShowLinkAcct.php?PostType="+PostType,cache:false,success:function(result){
            $('#ShowValueFrank24').html(result);
        }});
    });
  </script>

<script>
    $('#d_channel').change(function(){
        var PostType=$('#d_channel').val();
        $.ajax({url:"Ajax-ShowBankOption.php?PostType="+PostType,cache:false,success:function(result){
            $('#ShowValueFrank50').html(result);
        }});
    });
  </script>
  
  <script>
     $('#upgrade_subplancat').change(function(){
         var PostType=$('#upgrade_subplancat').val();
         $.ajax({url:"Ajax-ShowUpgradePlanCat.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrankPlanCat').html(result);
         }});
     });
  </script>
...
<script>
     $('#billpay').change(function(){
         var PostType=$('#billpay').val();
         $.ajax({url:"Ajax-BillPamentCategory.php?PostType="+PostType,cache:false,success:function(result){
             $('#ShowValueFrank').html(result);
         }});
     });
 </script>
...
$(document).ready(function(){
setInterval(function(){
$("#mastercardwallet_balance").load('mastercard_balance_sync.php')
}, 2000);
});
</script>
...
$("#loan_required_doc").load('loan_required_doc.php?lid=<?php echo $_GET["lid"]; ?>')
...
$("#mandate_status").load('synchronize_mandatestatus.php')
}, 2000);
});
</script>
...
$(document).ready(function(){
    ...
    $("#id_wupload").click(function(){

        var fd = new FormData();

        var files = $('#idwFile')[0].files;
        ...
        if(files.length > 0 ){
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend:function(){
                    $('#id_wupload').attr('disabled', 'disabled');
                    $('#process').css('display', 'block');
                },
                success:function(response){
    ...
    function progress_bar_process(percentage, timer){
        ...
        if(percentage > 100){
            ...
            $('#process').css('display', 'none');
            $('.progress-bar').css('width', '0%');
            $('#id_wupload').attr('disabled', false);
            $('#success_message').html("<div class='alert alert-success'>File uploaded successfully</div>");
            setTimeout(function(){
                $('#success_message').html('');
            }, 5000);
...
$(document).ready(function(){
    ...
    $("#wutility_upload").click(function(){

        var fd = new FormData();

        var files = $('#wutilityFile')[0].files;
        ...
        if(files.length > 0 ){
            ...
            fd.append('wutility_file',files[0]);
            fd.append('myid',myid);

            $.ajax({
                url:'uploadwutility.php',
                type:'post',
                data:fd,
                contentType: false,
                processData: false,
                beforeSend:function(){
                    $('#wutility_upload').attr('disabled', 'disabled');
                    $('#process').css('display', 'block');
                },
                success:function(response){
    ...
    function progress_bar_process(percentage, timer){
        ...
        if(percentage > 100){
            ...
            $('#process').css('display', 'none');
            $('.progress-bar').css('width', '0%');
            $('#wutility_upload').attr('disabled', false);
            $('#success_message').html("<div class='alert alert-success'>File uploaded successfully</div>");
            setTimeout(function(){
                $('#success_message').html('');
            }, 5000);
...
$(document).ready(function(){
    ...
    $("#wsignature_upload").click(function(){

        var fd = new FormData();

        var files = $('#wsignatureFile')[0].files;
        ...
        if(files.length > 0 ){
            ...
            fd.append('wsignature_file',files[0]);
            fd.append('myid',myid);

            $.ajax({
                url:'uploadwsignature.php',
                type:'post',
                data:fd,
                contentType: false,
                processData: false,
                beforeSend:function(){
                    $('#wsignature_upload').attr('disabled', 'disabled');
                    $('#process').css('display', 'block');
                },
                success:function(response){
    ...
    function progress_bar_process(percentage, timer){
        ...
        if(percentage > 100){
            ...
            $('#process').css('display', 'none');
            $('.progress-bar').css('width', '0%');
            $('#wsignature_upload').attr('disabled', false);
            $('#success_message').html("<div class='alert alert-success'>File uploaded successfully</div>");
            setTimeout(function(){
                $('#success_message').html('');
            }, 5000);
...
<?php
if(($ilvWidgetStatus == "" || $ilvWidgetStatus == "NotActivated") && !(isMobileDevice()))
{
?>
...
elseif($ilvWidgetStatus == "Activated" && !(isMobileDevice())){

    echo base64_decode($ifetch_lvWidget['livechat_widget']);
