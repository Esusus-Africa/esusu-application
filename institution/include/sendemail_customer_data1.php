<div class="box">
            ...
            <h3 class="panel-title"><a href="customer.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("403"); ?>&&mid=NDAz"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a><i class="fa fa-envelope-o"></i> New Email</h3>
            </div>
             <div class="box-body">
...
if (isset($_POST['send']))
{
	...
	if($email == "All")
	{
		$search_cust = mysqli_query($link, "SELECT * FROM borrowers WHERE branchid = '$session_id'") or die("Error:" . mysqli_error($link));
		...
		$search_cust = mysqli_query($link, "SELECT * FROM borrowers WHERE branchid = '$session_id' AND email = '$email'") or die("Error:" . mysqli_error($link));
