...
if(mysqli_num_rows($search_duration) == 0){
    ...
    echo "<span style='color: white; font-size: 16px'>Subscription Expired: <a href='make_saas_sub.php?tid=".$_SESSION['tid']."&&mid=NDIw' class='btn bg-orange'><b>Renew Subscription</b></a></span>";
...
var countdownDiv = document.getElementById("countdown");
countdownDiv.innerHTML = "<button type='button' class='btn btn-flat bg-<?php echo ($myaltrow['theme_color'] == "") ? "blue" : $myaltrow['theme_color']; ?>' align='left'><span style='color: white; font-size: 16px'><font color=#ffffff><b style='font-size: 16px'>" + dmin + "</b> minutes <b style='font-size: 16px'>" + dsec + "</b> seconds</span></botton>";
      ...
      ?>
          ...
          <?php }}?>
              ...
              <li class="user-body">
                ...
                <?php echo ($view_all_tickets == 1) ? '<div class="col-xs-4 text-center"><a href="inboxmessage.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("406").'"><b>All Tickets</b></a></div>' : ''; ?>
                </div>
                <!-- /.row -->
              </li>
              <!-- Menu Footer-->
