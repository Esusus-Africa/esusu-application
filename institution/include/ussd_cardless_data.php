<div class="box">
	       <div class="box-body">
            ...
            <button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>" align="left">&nbsp;<b>Pending Balance:</b>&nbsp;
                <strong class="alert bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>">
                <?php
                ($irole == "agent_manager" || $irole == "institution_super_admin" || $irole == "merchant_super_admin") ? $search_Terminal = mysqli_query($link, "SELECT SUM(pending_balance) FROM terminal_reg WHERE merchant_id = '$institution_id'") : "";
                ($irole != "agent_manager" && $irole != "institution_super_admin" && $irole != "merchant_super_admin") ? $search_Terminal = mysqli_query($link, "SELECT SUM(pending_balance) FROM terminal_reg WHERE merchant_id = '$institution_id' AND tidoperator = '$iuid'") : "";
