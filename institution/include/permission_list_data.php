...
<form method="post">
	...
	<hr>		
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$select = mysqli_query($link, "SELECT * FROM my_permission WHERE companyid = '$institution_id'") or die (mysqli_error($link));
...
?>    
                ...
                <td>
				<a rel="tooltip" title="View" href="view_perm.php?id=<?php echo $id;?>&&mid=<?php echo base64_encode("413"); ?>"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><i class="fa fa-eye"></i></button></a>
				<a rel="tooltip" title="Update" href="edit_cperm.php?id=<?php echo $id;?>&&mid=<?php echo base64_encode("413"); ?>"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-edit"></i></button></a>
			</td>		    
			    </tr>
<?php } } ?>
             </tbody>
