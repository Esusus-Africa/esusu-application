...
<form method="post">
	 ...
	 <?php echo ($delete_branches == '1') ? '<button type="submit" class="btn bg-'.$myaltrow['alternate_color'].' == "" ? orange : '.$myaltrow['alternate_color'].'" name="delete"><i class="fa fa-times"></i>&nbsp;Multiple Delete</button>' : ''; ?>
	<hr>				  
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$select = mysqli_query($link, "SELECT * FROM branches WHERE created_by = '$institution_id' ORDER BY id DESC") or die (mysqli_error($link));
...
?>    
				...
				<td><div class="alert bg-orange" align="center"><b><?php echo $get_num; ?></b></div></td>
				...
				<div class="btn-group">
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <?php echo ($update_branches == '1') ? '<li><p><a href="edit_branches.php?id='.$_SESSION['tid'].'&&idm='.$id.'&&mid=NDAy" class="btn bg-'.$myaltrow['theme_color'].' == "" ? blue : '.$myaltrow['theme_color'].'"><i class="fa fa-edit">&nbsp;Edit</i></a></p></li>' : '<span style="color: red;">--Not Authorized--</span>'; ?>
                          <?php echo ($view_all_transaction == '1') ? '<li><p><a href="view_transaction?id='.$_SESSION['tid'].'&&idm='.$branchid.'&&mid=NDAy" class="btn bg-'.$myaltrow['theme_color'].' == "" ? blue : '.$myaltrow['theme_color'].'"><i class="fa fa-search">&nbsp;View Transaction</i></a></p></li>' : '<span style="color: red;">--Not Authorized--</span>'; ?>
						</ul>
                      </div>
                </div>
				</td>
...
<?php } } ?>
						...
						echo "<script>window.location='listbranches.php?id=".$_SESSION['tid']."&&mid=NDAy'; </script>";
							}
							else{
							for($i=0; $i < $N; $i++)
							{
