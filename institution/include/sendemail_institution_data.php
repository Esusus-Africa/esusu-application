...
?>				
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<optgroup label="SELECT INDIVIDUAL / ALL INSTITUTION">
					<?php
					...
					echo "<option value='All'>All Institutions ($num)</option>";
					while($rows = mysqli_fetch_array($get))
					{
						
					?>
					<option value="<?php echo $rows['official_email']; ?>"><?php echo $rows['institution_name']; ?></option>
					<?php } } ?>	
					</optgroup>					
					</select>
				  </div>
