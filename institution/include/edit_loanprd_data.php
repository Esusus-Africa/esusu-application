...
if(isset($_POST['save']))
{
  ...
  $penalty_type = mysqli_real_escape_string($link, $_POST['penalty_type']);
	...
	$insert = mysqli_query($link, "UPDATE loan_product SET category='$cat', pname='$pname', interest='$interest_rate', duration='$lduration', tenor='$tenor', interest_type='$interest_type', penalty_type = '$penalty_type', penalty_rate = '$penalty_rate' WHERE id = '$lprd_id'");
	if(!$insert)
	{
...
?>			 
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>">Tenor</label>
				 <div class="col-sm-9">
                <select name="tenor" class="form-control select2" style="width: 100%;" required>
        ...
        <div class="form-group">
				...
				<option value="<?php echo $get_lprd->penalty_type; ?>" selected="selected"><?php echo $get_lprd->penalty_type; ?></option>
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input name="penalty_rate" type="text" class="form-control" value="<?php echo $get_lprd->penalty_rate; ?>" placeholder="Penalty Rate" required>
                  </div>
                  </div>
