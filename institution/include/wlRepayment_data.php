	...
	<hr>
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<?php echo ($wallet_loan_repayment === '1' && $individual_wallet_loan_repayment === '' && $branch_wallet_loan_repayment === '' ? '<option value="all">All Repayment</option>' : ($wallet_loan_repayment === '' && $individual_wallet_loan_repayment === '1' && $branch_wallet_loan_repayment === '' ? '<option value="all1">All Repayment</option>' : ($wallet_loan_repayment === '' && $individual_wallet_loan_repayment === '' && $branch_wallet_loan_repayment === '1' ? '<option value="all2">All Repayment</option>' : ''))); ?>
			...
			<hr>
            <div class="table-responsive">
			    <table id="fetch_wlRepayment_data" class="table table-bordered table-striped">
			        <thead>
                    <tr>
