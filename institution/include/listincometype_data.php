...
<form method="post">
			...
			<?php echo ($add_view_incometype == 1) ? '<a href="addincometype.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("500").'"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-plus"></i>&nbsp;Add Income Type</button></a>' : ''; ?>
...
<?php
						...
						echo "<script>window.location='listincometype.php?id=".$_SESSION['tid']."&&mid=NTAw'; </script>";
							}
							else{
							for($i=0; $i < $N; $i++)
							{
