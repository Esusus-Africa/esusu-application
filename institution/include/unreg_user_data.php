<div class="box">
		 ...
		 <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="newpayroll.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDIz"><button type="button" class="btn btn-flat bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-user"></i> New Staff </h3>
            </div>
             <div class="box-body">

			 
               
			 <form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_unreg_emp.php">
		...
		<div class="form-group">
				...
				<select name="country"  class="form-control select2" required>
										<option value="" selected='selected'>Select a country&hellip;</option>
			...
			<div class="form-group">
				...
				<select name="branch"  class="form-control select2">
										<option selected='selected'>Select a branch&hellip;</option>
<?php 
...
<?php } ?>
              ...
              <div class="box-footer">
                				<button name="emp" type="submit" class="btn bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"><i class="fa fa-save">&nbsp;Submit</i></button>
