...
<form method="post">
			...
			<?php echo ($delete_notice == 1) ? '<button type="submit" class="btn btn-flat bg-'.$myaltrow['alternate_color'].' == "" ? orange : '.$myaltrow['alternate_color'].'" name="delete"><i class="fa fa-times"></i>&nbsp;Multiple Delete</button>' : ''; ?>
			 
	<?php echo ($add_notice == 1) ? '<a href="add_newsboard.php?id='.$_SESSION['tid'].'&&mid=NDE1"><button type="button" class="btn btn-flat bg-'.$myaltrow['theme_color'].' == "" ? blue : '.$myaltrow['theme_color'].'"><i class="fa fa-plus"></i>&nbsp;Add Notice</button></a>' : ''; ?>
	<hr>		
