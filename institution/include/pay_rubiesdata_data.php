...
<!--- AIRTIME FORM START HERE -->
             ...
             <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Data Products:</label>
                    <div class="col-sm-6">
...
if(isset($_POST['PayBill1']))
{
    ...
    if($amount_recharge <= 0){
        ...
        $dataToProcess = $reference."|".$amount_recharge."|".$operator."|".$phone."|".$itransfer_balance."|".$pcode;
        ...
        if($rubbies_generate['responsecode'] == "00" && $itransfer_balance >= $amount_recharge){
        	...
        	$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$institution_id','$transaction_id','$phone','','$amount','Debit','$icurrency','Databundle - WEB','$operator Databundle Purchase for $pcode with refid: $transaction_id via WEB','successful','$datetime','$iuid','$senderBalance2','')");
        	
        	$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$institution_id','$transaction_id','$phone','$commission','','Credit','$icurrency','Commission - WEB','$operator Databundle Purchase Commission for $pcode with refid: $transaction_id via WEB','successful','$datetime','$iuid','$senderBalance2','')");
