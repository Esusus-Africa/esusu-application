...
<div class="content-wrapper">
    ...
    <section class="content">
		<?php include("include/listpendingpayment_data.php"); ?>
	</section>
</div>	
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
  ...
  var dataTable = $('#fetch_allpendingrepayment_data').DataTable({
   "processing" : true,
   "serverSide" : true,
   'serverMethod': 'post',
   "ajax" : {
    url:"fetch_allpendingrepayment_report.php",
    'data': function(data){
        // Read values
