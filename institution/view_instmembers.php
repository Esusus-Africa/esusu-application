                  ...
                  <div class="btn-group">
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <?php echo ($update_members_info == 1) ? '<li><p><a href="edit_instmembers.php?id='.$_SESSION['tid'].'&&idm='.$id.'&&instid='.$_GET['instid'].'&&mid=NDE5&&tab=tab_1" class="btn bg-orange btn-flat"><i class="fa fa-edit">&nbsp;Edit</i></a></p></li>' : ''; ?>
                        </ul>
                      </div>
                  </div>
                  </td>	    
...
<?php } } ?>
            ...
            echo "<script>window.location='view_instmembers.php?id=".$_SESSION['tid']."&&mid=NDE5'; </script>";
              }
              else{
              for($i=0; $i < $N; $i++)
              {
