...
?>          
          ...
          <option disabled>CUSTOMER LIST</option>
					<?php
            ($individual_customer_records != "1" && $branch_customer_records != "1") ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE branchid = '$institution_id' ORDER BY id") or die (mysqli_error($link)) : "";
    				($individual_customer_records === "1" && $branch_customer_records != "1") ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE branchid = '$institution_id' AND lofficer = '$iuid' ORDER BY id") or die (mysqli_error($link)) : "";
    				($individual_customer_records != "1" && $branch_customer_records === "1") ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE branchid = '$institution_id' AND sbranchid = '$isbranchid' ORDER BY id") or die (mysqli_error($link)) : "";
        ...
        <span style="color:<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"><b>NOTE:</b> User Phone number must be in international format. If not, kindly update the user information first before you proceed with the card issuing / topup.</span>
			</div>
			</div>
                  
            <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Billing Address</label>
                  	<div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Billing City</label>
                  <div class="col-sm-10">
      ...
      <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Billing State</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Billing Postal/Zip Code</label>
                  <div class="col-sm-10">
            ...
            <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Billing Country</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  ...
                  <span style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"> <b>Here, you need to enter the Amount to Prefund the Card with on Card Creation.</span>
                  </div>
                  </div>
...
<hr>
            ...
            <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Secure Option</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">PIN (Optional)</label>
                  <div class="col-sm-10">
                  <input name="pin" type="text" class="form-control" value="1111" maxlength="4" readonly>
                  <span style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"> <b>This section is applicable only if PIN is choosen above as Customer Security Check which they can later change easily via there end after issuing the card</span>
                  </div>
                  </div>
...
?>
          ...
          <option disabled>CUSTOMER LIST</option>
            ...
            ($individual_customer_records != "1" && $branch_customer_records != "1") ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE card_reg = 'Yes' AND card_issurer = 'Mastercard' AND branchid = '$institution_id' ORDER BY id") or die (mysqli_error($link)) : "";
    				($individual_customer_records === "1" && $branch_customer_records != "1") ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE card_reg = 'Yes' AND card_issurer = 'Mastercard' AND branchid = '$institution_id' AND lofficer = '$iuid' ORDER BY id") or die (mysqli_error($link)) : "";
...
?>
        ...
        <div class="form-group">
				...
				<select name="customer"  class="form-control select2" required>
                    ...
                    <option disabled>CUSTOMER LIST</option>
                    <?php
                    (($individual_customer_records != "1" && $branch_customer_records != "1") || ($individual_wallet != "1" && $branch_wallet != "1")) ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE card_reg = 'Yes' AND card_issurer = 'VerveCard' AND branchid = '$institution_id' AND card_id != 'NULL' ORDER BY id") or die (mysqli_error($link)) : "";
                    (($individual_customer_records === "1" && $branch_customer_records != "1") || ($individual_wallet === "1" && $branch_wallet != "1")) ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE card_reg = 'Yes' AND card_issurer = 'VerveCard' AND branchid = '$institution_id' AND card_id != 'NULL' AND lofficer = '$iuid' ORDER BY id") or die (mysqli_error($link)) : "";
                    (($individual_customer_records != "1" && $branch_customer_records === "1") || ($individual_wallet != "1" && $branch_wallet === "1")) ? $search = mysqli_query($link, "SELECT * FROM borrowers WHERE card_reg = 'Yes' AND card_issurer = 'VerveCard' AND branchid = '$institution_id' AND card_id != 'NULL' AND sbranchid = '$isbranchid' ORDER BY id") or die (mysqli_error($link)) : "";
                    while($get_search = mysqli_fetch_array($search))
                    {
                        $api_name =  "display_card_bal";
                        $issurer = $get_search['card_issurer'];
                    ...
                    ($individual_wallet === "1" && $branch_wallet != "1") ? $get3 = mysqli_query($link, "SELECT * FROM user WHERE created_by = '$institution_id' AND (acctOfficer = '$iuid' OR id = '$iuid') AND card_reg = 'Yes' AND card_issurer = 'VerveCard' AND card_id != 'NULL' ORDER BY userid DESC") or die (mysqli_error($link)) : "";
		...
		<!--<div class="form-group">
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="amount" type="text" class="form-control" placeholder="Enter the amount to prefund the card with" required>
                  <span style="color: <?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>;"> <b>Here, you need to enter the Amount to Prefund the Card with.</span>
                  </div>
                  </div>
