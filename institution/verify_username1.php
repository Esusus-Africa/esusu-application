...
if(isset($_POST['my_username']))
{
   ...
   //$link = mysqli_connect('localhost','root','root','loan2','8888') or die('Unable to Connect to Database');
     ...
     $search_uname = mysqli_query($link, "SELECT * FROM user WHERE username = '$myuname'");
      ...
      $search_muname = mysqli_query($link, "SELECT * FROM borrowers WHERE username = '$myuname'");
    //print_r($result);
...
if(isset($_POST['my_email']))
{
  ...
  //$link = mysqli_connect('localhost','root','root','loan2','8888') or die('Unable to Connect to Database');
    ...
    $search_muemail = mysqli_query($link, "SELECT * FROM borrowers WHERE email = '$myemail'");
    //print_r($result);
...
if(isset($_POST['my_phone']))
{
  ...
  //$link = mysqli_connect('localhost','root','root','loan2','8888') or die('Unable to Connect to Database');
    ...
    $search_muphone = mysqli_query($link, "SELECT * FROM borrowers WHERE phone = '$myphone'");
    //print_r($result);
