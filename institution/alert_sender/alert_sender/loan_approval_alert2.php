...
if($iassigned_walletbal >= $sms_rate)
{
    ...
    $message2 = "$sender>>>Loan Disapproved | ";
    $message2 .= "Dear ".$fname."! ";
    $message2 .= "Your Loan Application with Loan ID: ".$LID." of ".$icurrency.number_format($amount,2,'.',',')." has been disapproved on ".date('Y-m-d')." ";
    $message2 .= "Kindly contact us for more info. Thanks";
    $debug = true;
