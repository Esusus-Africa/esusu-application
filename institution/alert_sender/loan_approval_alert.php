...
if($iassigned_walletbal >= $sms_rate)
{
    ...
    $message2 = "$sender>>>Loan Approved | ";
	$message2 .= "Dear ".$fname."! ";
	$message2 .= "Your Loan Application with Loan ID: ".$lid." of ".$icurrency.number_format($amount,2,'.',',')." has been Approved on ".date('Y-m-d')." ";
	$message2 .= "Kindly await disbursement to your account soon. Thanks.";
	$debug = true;
