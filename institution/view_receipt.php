    ...
    <div class="modal-dialog" id="printableArea">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <legend style="color: blue;"><?php echo (($row['t_type'] == "Withdraw") ? 'Withdraw Receipt | Date/Time: '.$row['date_time'] : (($row['t_type'] == "Withdraw-Charges") ? 'Withdraw-Charges | Date/Time: '.$row['date_time'] : (($row['t_type'] == "Deposit") ? 'Deposit Receipt | Date/Time: '.$row['date_time'] : (($row['t_type'] == "Transfer") ? 'Transfer Receipt | Date/Time: '.$row['date_time'] : 'In-to-In Transfer Receipt | Date/Time: '.$row['date_time'])))); ?></legend>
