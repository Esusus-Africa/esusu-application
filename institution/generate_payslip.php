...
<div class="wrapper">
  ...
  <br>
		   ...
		   <div align="center"><img src="<?php echo $fetchsys_config['file_baseurl'].$row['logo'];?>" width="80" height="80" class="user-image" alt="User Image">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
           ...
           <div style="color:blue"><div style="font-size:21px"><div align="center"><b><?php echo '&nbsp;&nbsp;&nbsp;'. $inst_name; ?></b></div></div></div>
