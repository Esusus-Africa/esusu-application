...
<div class="wrapper">
  ...
  <?php 
		 ...
		 {
		 ?>
		   <div align="center"><img src="../img/<?php echo $row['image'];?>" width="80" height="80" class="user-image" alt="<?php echo $row['name'];?>">
		 <?php }?>
		 </div>
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
		...
		{
?>
           <div style="color:#009900"><div style="font-size:20px"><div align="center"><b><?php echo '&nbsp;&nbsp;&nbsp;'. $row ['name'];?></b></div></div></div>
...
?>  
			   ...
			   <td><?php echo ($row['teller'] == "") ? '<span class="label label-info">Waiting for Review</span>' : $row['teller']; ?></td>
