			...
			<div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;">Loan Tenor (<?php echo $tenor; ?>):</label>
				 <div class="col-sm-10">
                     ...
                     <hr>
					 <span style="color: <?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>;"><b>Please note that the Repayment Fee will be Calculated Automatically as soon as you upload the loan records based on the Loan Product selected above.</b></span>
				     <hr>
				 </div>
			 </div>