...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy != "all" && $filterBy != "all1" && $filterBy != "all2"){
    ...
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND remarks = 'pending' AND (tid = '$filterBy' OR account_no = '$filterBy' OR sbranchid = '$filterBy')
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all"){
    ...
    $query .= "SELECT * FROM payments 
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND remarks = 'pending'
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all1"){
    ...
    $query .= "SELECT * FROM payments 
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND tid = '$iuid' AND remarks = 'pending'
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all2"){
    ...
    $query .= "SELECT * FROM payments 
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND sbranchid = '$isbranchid' AND remarks = 'pending'
    ";
...
{
 $query = "SELECT * FROM payments WHERE branchid = '$institution_id' AND remarks = 'pending'";
 $statement = $connect->prepare($query);
 $statement->execute();
