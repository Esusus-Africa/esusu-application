...
$PostType = $_GET['PostType'];
  ...
  $billp_settings = mysqli_query($link, "SELECT * FROM billpayment WHERE companyid = '$institution_id' AND status = 'Active'");
...
?>
        ...
        <div class="form-group">
            <label for="" class="col-sm-3 control-label" style="color:blue">SmartCard Number1</label>
            <div class="col-sm-9">
