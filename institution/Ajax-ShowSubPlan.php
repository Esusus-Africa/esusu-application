...
<div class="columns">
  <ul class="price">
    ...
    <li class="bg-<?php echo ($myaltrow['alternate_color'] == '') ? 'orange' : $myaltrow['alternate_color']; ?>">
      <a href="finalize_saassub.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDIw&&pcode=<?php echo $fetch_subplan['plan_code']; ?>"><button type="button" class="btn bg-<?php echo ($myaltrow['theme_color'] == '') ? 'blue' : $myaltrow['theme_color']; ?>"> <i class="fa fa-search">&nbsp;Activate</i></button></a>
    </li>
  </ul>
</div>
