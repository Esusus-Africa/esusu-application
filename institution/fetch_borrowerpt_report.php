...
$column = array('id', 'Branch', 'Vendor', 'Borrowers Name', 'Num. of Loan', 'Principal Amount', 'Total Repayment', 'Pending Balance', 'Total Interest', 'Grand Total');
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy != "all"){
    ...
    WHERE date_release BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND (status = 'Approved' OR status = 'Disbursed') AND (branchid = '$filterBy' OR sbranchid = '$filterBy' OR vendorid = '$filterBy' OR agent = '$filterBy' OR baccount = '$filterBy')
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all"){
    ...
    $query .= "SELECT * FROM loan_info 
    WHERE date_release BETWEEN '$startDate' AND '$endDate' AND branchid = '$institution_id' AND (status = 'Approved' OR status = 'Disbursed')
    ";
