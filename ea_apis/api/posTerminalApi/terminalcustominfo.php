...
if($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $customResults = $Pos->terminalCustomInfo($authReceived);
    ...
    if($results === -1){
        ...
        $newhttp->customAccessForbidden('Unknown Terminal serial', $customResults);
        
    }else{

        $newhttp->OK($resultsInfo, $results, $customResults);
