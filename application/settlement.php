...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Settlement History for Bank - Wallet Investment Transaction
    ...
    <section class="content">
		<?php
      include("include/settlement_data.php"); 
    ?>
	</section>
</div>	
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
  ...
  var dataTable = $('#settlement_history_data').DataTable({
   "processing" : true,
   "serverSide" : true,
   'serverMethod': 'post',
   "ajax" : {
    url:"fetch_settlement_history.php",
    'data': function(data){
        // Read values
