			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
			 ...
			 <div class="box-body">
				...
				<div class="form-group">
					...
					<?php
					$get6 = mysqli_query($link, "SELECT * FROM branches WHERE bstatus = 'Operational' ORDER BY id DESC") or die (mysqli_error($link));
					while($rows6 = mysqli_fetch_array($get6))
					{
					?>
					<option value="<?php echo $rows6['branchid']; ?>"><?php echo $rows6['bname'].' ['.$rows6['branchid'].']'; ?></option>
					<?php } ?>
				</select>
					</div>
				</div>
			...
			<hr>		
			 ...
			 <table id="fetch_idVerificationsrpt_data" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Total NIN VCharges</th>
                  <th>Total BVN VCharges</th>
                  <th>Grand Total</th>
                 </tr>
                </thead>
                </table>
