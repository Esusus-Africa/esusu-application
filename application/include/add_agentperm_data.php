			  ...
			  <tr class="form-group" width="100%">
				...
				<div class="form-group">
	                ...
	                <select name="tide"  class="form-control select2" required>
						...
						<?php
						$search_user = mysqli_query($link, "SELECT * FROM institution_user WHERE institution_id = '$instid'") or die ("Error: " . mysqli_error($link));
						while($get_users = mysqli_fetch_array($search_user))
						{
						?>		
						<option value="<?php echo $get_users['directorate_id']; ?>"><?php echo $get_users['d_name']; ?></option>
						<?php } ?>
