...
?>
		<form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_msg1.php">
			 ...
			 <div class="box-body">
				...
				<div class="box-body">
					<p>
						<h4><b style="color: green;"><?php echo $row['sender_name']; ?></b> <b style="color: red;">(<?php echo $row['subject']; ?>)</b> - <i><?php echo $row['date_time']; ?></i></h4>
					</p>
					<p>
...
?>		  
				<div class="box-body">
					<p>
						<h4><b style="color: green;"><?php echo $row2['sender_name']; ?></b> <b style="color: red;">(<?php echo $row2['subject']; ?>)</b> - <i><?php echo $row2['date_time']; ?></i></h4>
					</p>
					<p>
