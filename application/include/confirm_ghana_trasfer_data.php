<div class="box">
           <div class="box-body">
            ...
            <h3 class="panel-title"><a href="transfer_fund.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDA0&&tab=tab_4" class="btn bg-orange"><i class="fa fa-reply-all"></i> Retry</a> <i class="fa fa-money"></i> OTP Confirmation Form</h3>
            </div>
             <div class="box-body">
...
if(isset($_POST['save']))
{
    ...
    $google_details = mysqli_query($link, "SELECT * FROM ghana_pmt_confirmation WHERE otp_code = '$otp_code'");
    if(mysqli_num_rows($google_details) == 0)
    {
        ...
        $branch_code = $get_details1['bankcode'];
        ...
        $seckey = $row1->secret_key;
            ...
            if($result['status'] == "success"){
                ...
                $delete_confirmation = mysqli_query($link, "DELETE FROM ghana_pmt_confirmation WHERE id = '$id'");
                $delete_confirmation = mysqli_query($link, "DELETE FROM ghana_pmt_confirmation WHERE phone = '$phone'");
                echo '<meta http-equiv="refresh" content="6;url=transfer_fund.php?id='.$_SESSION['tid'].'&&mid=NDA0&&tab=tab_4">';
                echo '<br>';
                echo "<div align='center'><img src='../image/checkmark.gif'><p style='color: #38A1F3;'>Transfer Initiated Successful!</p></div>";
            }
            else{
                echo '<meta http-equiv="refresh" content="5;url=transfer_fund.php?id='.$_SESSION['tid'].'&&mid=NDA0&&tab=tab_4">';
                echo '<br>';
