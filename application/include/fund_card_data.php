...
if(isset($_POST['save']))
{
	...
	if($result['Status'] == "success")
	{
		...
		$insert = mysqli_query($link, "INSERT INTO wallet_history VALUES(null,'$account','$txid','$amount','$debit_currency','card-funding','$postedby','successful',NOW())");
			...
			<div class="demo-container">
				...
				<div align="center">
                  <div class="box-footer">
                    <button name="save" type="submit" class="btn bg-blue"><i class="fa fa-spinner">&nbsp;Fund Card</i></button>
                  </div>
			    </div>
				</span>
