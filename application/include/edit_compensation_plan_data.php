<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="compensation_plan.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDE2"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-newspaper-o"></i>  Edit Compensation Plan</h3>
            </div>
...
if(isset($_POST['save']))
{
  $plid = $_GET['plid'];
	...
	$update = mysqli_query($link, "UPDATE compensation_plan SET plan_level='$plan_level', percentage='$percentage' WHERE id = '$plid'") or die ("Error: " . mysqli_error($link));
	if(!$update)
	{
