...
$g_position =  mysqli_real_escape_string($link, $_POST['g_position']);
...
$sbranch = mysqli_real_escape_string($link, $_POST['branch']);
...
//$check_c_sign = getimagesize($_FILES["c_sign"]["tmp_name"]);
	...
	//$today = date("Y-m-d");
	$insert = mysqli_query($link, "INSERT INTO borrowers VALUES(null,'',$fname','$lname','$email','$phone','$gender','$dob','$occupation','$addrs','','','','$country','$nok','$nok_rela','$nok_phone','Borrower','$account','$username','$password','0.0','0.0','$location',NOW(),'0000-00-00','$status','$lofficer','','','$sbranch','Not-Activated','$c_interval','$d_interval','$otp','NGN','0.0','$overdraft','Null','No','0000','$acct_type','$reg_type','$gname','$g_position')") or die (mysqli_error($link));
	//$insert = mysqli_query($link, "INSERT INTO borrower_form VALUES(null,'$account','$loaction_c_sign')") or die (mysqli_error($link));
	
	$protocol = ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://";
	$url = $protocol . $_SERVER['HTTP_HOST']."/index?acn=".$account;
	...
	$shortenedurl = $protocol . $_SERVER['HTTP_HOST'] . '/index?activation_key=' . $shorturl;
	$shortenedurl1 = $protocol . $_SERVER['HTTP_HOST'] . '/index?deactivation_key=' . $shorturl;
	...
	$sms = "$sys_abb>>>Welcome $fname! Your Account ID: $account, Username: $username, Password: $password, Transaction Pin: 0000. Download App at bit.ly/esusuafrica_app";

	if($insert)
	{
		include('../cron/sendgeneral_sms.php');
...
?>           
			...
			<div class="form-group">
 						...
 						<select name="acct_type" class="form-control select2" required>
 												...
 												<?php
 												$search_accttype = mysqli_query($link, "SELECT * FROM account_type");
                ...
                <div class="form-group">
 		                  <label for="" class="col-sm-2 control-label" style="color:blue;">Registration Type</label>
 		                  <div class="col-sm-10">
...
?>
		...
		<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="email" name="email" type="text" id="vbemail" onkeyup="veryBEmail();" class="form-control" placeholder="Email">
		...
		<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="phone" type="text" class="form-control" id="vbphone" onkeyup="veryBPhone();" placeholder="Mobile Number" required>
		...
		<div class="form-group">
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
				<select name="lofficer" class="form-control select2" required>
										<option value="" selected='selected'>Assign Staff&hellip;</option>
										<?php
$search = mysqli_query($link, "SELECT * FROM user WHERE utype != 'Unregistered' AND role != 'super-admin'");
...
<?php } ?>
				...
				<span style="color: orange;"> You can assign customer to the above account officers. This will allow you to download the collection sheet for each staff and the staff will know which customers to work with. </span><br>
		</div>
		</div>
		...
		<div class="form-group">
				...
				<select name="branch"  class="form-control select2">
							<option value="">Head Office</option>
										<?php
$search = mysqli_query($link, "SELECT * FROM branches");
while($get_search = mysqli_fetch_array($search))
{
?>
...
<?php } ?>
		...
		<div class="form-group">
				...
				<span style="color: orange;">Enable OTP for Withdrawal</span>
		</div>
		</div>
...
<hr>
<div class="bg-orange">Upload Scanned Copy of the Registration Form Filled by the Customer</div>
<hr>
...
<div class="box-body">
	...
	<div class="form-group">
           <label for="" class="col-sm-2 control-label" style="color: blue;">Import Customer:</label>
	<div class="col-sm-10">
