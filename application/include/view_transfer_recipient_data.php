...
<a href="create_transfer_recipient.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("404"); ?>"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-plus"></i>&nbsp;Add Transfer Recipient</button></a>
...
<?php
$date_now = date("Y-m-d");
$select = mysqli_query($link, "SELECT * FROM transfer_recipient ORDER BY id") or die (mysqli_error($link));
...
?> 
                <tr>
				<td><input id="optionsCheckbox" class="checkbox" name="selector[]" type="checkbox" value="<?php echo $recipient_id; ?>"></td>
				<td><b><?php echo ($row['companyid'] == "") ? "--------" : $row['companyid']; ?></b></td>
