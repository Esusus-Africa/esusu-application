		...
		<div class="form-group">
			 ...
			 <div class="form-group">
                  ...
                  <input name="account_no" type="text" class="form-control"  value="<?php echo $row['account']; ?>" readonly>
				    ...
				    <div class="form-group">
					<label for="" class="col-sm-2 control-label">Account Signature</label>
					<div class="col-sm-10">
							 <?php echo ($row['c_sign'] != "") ? '<img src="../'.$row['c_sign'].'" alt="Visa">' : '<span class="label label-danger">Account Not Verified!</span>'; ?>
					</div>
					</div>
