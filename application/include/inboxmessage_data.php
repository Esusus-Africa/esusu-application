...
<form method="post">
	...
	<?php echo ($close_tickets == 1) ? '<a href="outboxmessage.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("406").'"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-envelope"></i>&nbsp;Closed Tickets</button></a>' : ''; ?>
	<?php echo ($create_tickets == 1) ? '<a href="newmessage.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("406").'"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-plus"></i>&nbsp;New Ticket</button></a>' : ''; ?>
	<?php
...
?>   
				...
				<td><?php echo ($mstatus == 'Opened' ? $subject.' - '.'<span class="label bg-orange">'.$mstatus.'</span>' : ($mstatus == 'Closed' ? $subject.' - '.'<span class="label bg-blue">'.$mstatus.'</span>' : $subject.' - '.'<span class="label bg-orange">'.$mstatus.'</span>')); ?></td>
				<td align="center">
				<div class="btn-group">
                      <div class="btn-group">
