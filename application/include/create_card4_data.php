	 ...
	 <section class="content">
		 ...
		 <div class="col-md-14">
            ...
            <ul class="nav nav-tabs">
             <li <?php echo ($_GET['tab'] == 'tab_1') ? "class='active'" : ''; ?>><a href="create_card4.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("550"); ?>&&tab=tab_1">Card Enrollment Form</a></li>
             <li <?php echo ($_GET['tab'] == 'tab_2') ? "class='active'" : ''; ?>><a href="#create_card4.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("550"); ?>&&tab=tab_2">View Card</a></li>
              </ul>
...
if(isset($_GET['tab']) == true)
{
	...
	?>
			 ...
			 <form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_card4.php">
             <div class="box-body">
            ...
            <div class="form-group">
				...
				<select name="customer"  class="form-control select2" required>
						<option value='' selected='selected'>Select Merchant&hellip;</option>
										<?php
$search = mysqli_query($link, "SELECT * FROM merchant_reg WHERE role = 'Admin' ORDER BY id DESC");
while($get_search = mysqli_fetch_array($search))
{
?>
					<option value="<?php echo $get_search['merchantID']; ?>"><?php echo $get_search['company_name']; ?></option>
