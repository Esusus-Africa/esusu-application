<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="listincome.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("500"); ?>"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-calculator"></i>  Edit Income</h3>
            </div>
