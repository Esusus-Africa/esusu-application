...
elseif($_FILES["image"]["size"] > 500000)
{
	echo '<meta http-equiv="refresh" content="2;url=view_emp.php?tid='.$id.'&&mid='.base64_encode("409").'">';
	echo '<br>';
	echo'<span class="itext" style="color: #FF0000">Image must not be more than 500KB!</span>';
}
elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
{
	...
	$today = date("Y-m-d");
	$insert = mysqli_query($link, "INSERT INTO borrowers VALUES('','$fname','$lname','$email','$phone','$addrs1','$addrs2','$city','$state','$zip','$country','$comment','$account','0.0','$location',NOW(),'$today','$status','')") or die (mysqli_error($link));
	if(!$insert)
	{
		echo "<div class='alert alert-info'>Unable to Insert Borrower Records.....Please try again later</div>";
	}
	else{
		include("alert_sender/addcustomer_alert.php");
...
?>			  				
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
<?php
$account = '010'.rand(1000000,10000000);
?>
		...
		<div class="form-group">
				...
				<div class="form-group">
                  	...
                  	<div class="col-sm-10"><textarea name="comment"  class="form-control" rows="4" cols="80" readonly>Borrower</textarea></div>
          	</div>
