<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"><a href="newsboard.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDE1"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a>  <i class="fa fa-briefcase"></i> Notice Board</h3>
            </div>
             <div class="box-body">		
...
?>		  
				<div class="box-body">
					<p>
						<h4><b style="color: blue;"><?php echo $row2['caption']; ?></b></h4><i><p> Posted on <?php echo date('l, F, d, Y', strtotime($row2['sent_date'])); ?></p></i>
					</p>
					<p>
