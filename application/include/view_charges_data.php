...
<form method="post">
			 ...
			 <?php echo ($delete_client_charges == '1') ? '<button type="submit" class="btn btn-flat bg-orange" name="delete"><i class="fa fa-times"></i>&nbsp;Delete</button>' : ''; ?>	
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select name="ttype" id="transType" class="form-control select2" style="width:100%" required>
						...
						<option value="all">All Client Charges</option>
			...
			<hr>
			<div class="table-responsive">
			<table id="client_charges_data" class="table table-bordered table-striped">
				<thead>
				<tr>
...
<?php
						...
						echo "<script>window.location='view_charges.php?id=".$_SESSION['tid']."&&mid=".base64_encode("419")."'; </script>";
							}
							else{
							for($i=0; $i < $N; $i++)
							{
