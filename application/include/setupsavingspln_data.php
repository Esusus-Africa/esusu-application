...
<a href="addsavingpln.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("411"); ?>"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-plus"></i>&nbsp;Setup Savings Plan</button></a>
	<hr>		
