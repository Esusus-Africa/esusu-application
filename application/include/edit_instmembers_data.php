   ...
   <section class="content">
       ...
       <div class="box box-danger">
           <div class="box-body">
            ...
            <div class="box-body">
          <a href="view_instmembers?instid=<?php echo $_GET['instid']; ?>&&mid=NDE5"> <button type="button" class="btn btn-flat bg-orange"><i class="fa fa-reply-all"></i>&nbsp;Back</button></a>

     <div class="col-md-14">
            <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
             <li <?php echo ($_GET['tab'] == 'tab_1') ? "class='active'" : ''; ?>><a href="edit_instmembers?id=<?php echo $_SESSION['tid']; ?>&&idm=<?php echo $_GET['idm']; ?>&&instid=<?php echo $_GET['instid']; ?>&&mid=<?php echo base64_encode("419"); ?>&&tab=tab_1">Update Single Institution Member</a></li>
             <li <?php echo ($_GET['tab'] == 'tab_2') ? "class='active'" : ''; ?>><a href="edit_instmembers?id=<?php echo $_SESSION['tid']; ?>&&idm=<?php echo $_GET['idm']; ?>&&instid=<?php echo $_GET['instid']; ?>&&mid=<?php echo base64_encode("419"); ?>&&tab=tab_2">Update Bulk Institution Members</a></li>
              </ul>
...
?>
      ...
      <div class="form-group">
            <label for="" class="col-sm-2 control-label" style="color:blue;">Passport</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:blue;">Roles</label>
                  <div class="col-sm-10">
...
<div class="box-body">
  ...
  <p style="color:red"><b style="color:blue;">NOTE:</b><br>
    <span style="color:blue;">(1)</span> <i>Kindly download the <a href="../sample/update_instmembers.csv"> <b class="btn bg-blue"><i class="fa fa-download"></i> sample file</b></a> to upload the updated details once.</i></p>
    <span style="color:blue;">(3)</span> <i style="color:red;">Also, take note of the <span style="color: blue">d_image</span> which is to be written in this format: <b style="color:blue;">img/image_name.image_format</b>. The image format can be <b style="color: blue;">.png, .jpg, etc.</b></i></p>
    <span style="color:blue;">(3)</span> <i style="color:red;">Lastly, please note that the keywords you're expected to use while entering the User Role are: <span style="color: blue">super-admin, Admin OR Staff</span></i></p>
...
<div class="box-body">
  ...
  <p style="color:red"><b style="color:blue;">NOTICE:</b><br>
    <span style="color:blue;">(1)</span> <i style="color:red;">Upload the bulk image of just updated Institution members if needed, with the uses of your <span style="color: blue;">Control Key.</span></i></p>
  <hr>
