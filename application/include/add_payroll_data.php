<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="newpayroll.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDIz"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-paypal"></i>  Add Payroll</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO payroll VALUES(null,'','$branchid','$staff_id','$bizname','$payroll_date','$basic_pay','$overtime','$paid_leave','$transport_allowance','$medical_allowance','$bonus','$other_allowance','$total_pay','$pension','$health_insurance','$unpaid_leave','$tax_deduction','$salary_loan','$total_deduction','$net_pay','$pmethod','$bname','$acctno','$adesc','$comment','NGN')") or die ("Error: " . mysqli_error($link));
	...
	$get_cust = mysqli_fetch_object($search_cust);
		...
		$additionalheaders .= "Reply-To:noreply@esusu.africa \r\n";
...
?>				  
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-4">
                  <input name="bizname" type="text" class="form-control" value="<?php echo $rows2->name; ?>" required>
                  </div>
                  </div>
