...
<form method="post">
	...
	<?php echo ($delete_income == '1') ? '<button type="submit" class="btn btn-flat bg-orange" name="delete"><i class="fa fa-times"></i>&nbsp;Delete</button>' : ''; ?>		
	...
	<div class="box-body">
             ...
             <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select name="ttype" id="transType" class="form-control select2" style="width:100%" required>
					...
					<option value="all1">All Esusu Income Only</option>
              ...
              <hr>
              <div class="table-responsive">
              <table id="allincome_data" class="table table-bordered table-striped">
                <thead>
                <tr>
