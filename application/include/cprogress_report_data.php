<div class="box">
	       <div class="box-body">
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
			 <div class="alert bg-orange"> The Campaign report shows the <b>Project Contributed for with the Progress</b>. </div>
             <div class="box-body">
...
?>				  
			...
			<input name="branchid" type="hidden" class="form-control" value="<?php echo $rows->branchid; ?>">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-4"><span style="color:blue;"><b>Project</b></span><br>
				  	<select name="c_cat"  class="form-control select2" required>

				  <?php
				  $search = mysqli_query($link, "SELECT * FROM campaign");
				  ...
				  <?php } ?>
					...
					<span style="color: orange;">Select the Project Title / Project Tagline</span>
                  </div>
                </div>
...
if(isset($_POST['search'])){
	...
	echo "<script>window.location='cprogress_report.php?id=".$_SESSION['tid']."&&dfrom=".$dfrom."&&dto=".$dto."&&c_cat=".$c_cat."&&mid=NzUw'; </script>";
}
?>
...
?>
				...
				<td><?php echo ($get_project['current_fund'] == $get_project['budget']) ? "<span class='label label-success'>".$cal_percentage."%</span>" : "<span class='label label-danger'>".$cal_percentage."%</span>" ; ?>
					<p>
					<?php echo $fetch_lend_setup['currency'].number_format($get_project['current_fund'],2,'.',',').'&nbsp;'.'of'.'&nbsp;'.$fetch_lend_setup['currency'].number_format($get_project['budget'],2,'.',','); ?>
					</p>
				</td>				
				</tr>
<?php 
