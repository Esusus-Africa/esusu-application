<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="setupaccttype.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("411"); ?>&&mid=NDEx"><button type="button" class="btn bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-newspaper-o"></i>  Add Account Type</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO account_type VALUES(null,'','$acct_type','$interest_rate','$capped_amount')") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
...
?>           
			...
			<div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:blue;">Type</label>
				 <div class="col-sm-10">
                <input name="acct_type" type="text" class="form-control" placeholder="Account Type e.g. Regular" required>
              </div>
			  </div>
			...
			<div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:blue;">Capped Amount</label>
				 <div class="col-sm-10">
				     <input name="capped_amount" type="number" class="form-control" placeholder="Enter Capped Amount" required>
              </div>
			  </div>
