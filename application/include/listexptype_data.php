...
<form method="post">
			...
			<?php echo ($add_expense_type == 1) ? '<a href="addexptype.php?id='.$_SESSION['tid'].'&&mid='.base64_encode("500").'"><button type="button" class="btn btn-flat bg-blue"><i class="fa fa-plus"></i>&nbsp;Add Expense Type</button></a>' : ''; ?>
