<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="view_charges.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NTIw"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-asterisk"></i>  Add Charges</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO charge_management VALUES(null,'','$charges_name','$ctype','$charges_value',NOW())") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
