<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="listexpenses.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("422"); ?>&&mid=NDIy"><button type="button" class="btn btn-flat btn-warning"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-newspaper-o"></i>  Add Expense</h3>
            </div>
...
?>			 
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Expense Type</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Expense Amount</label>
                  <div class="col-sm-10">
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Expense Date</label>
                  <div class="col-sm-10">
