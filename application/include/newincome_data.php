<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="listincome.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NTAw"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-calculator"></i>  Add Income</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO income VALUES(null,'','$icm_id','$icm_type','$icm_amt','$icm_date','$icm_desc')") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
...
?>           
			...
			<div class="form-group">
				...
				<select name="icm_type" class="form-control select2" required>
					...
					<?php echo ($add_or_view_incometype == 1) ? '<span style="color: orange;"> <a href="listincometype.php?id='.$_SESSION['tid'].'&&mid=NTAw" target="_blank"> Add / Edit </a></span><br>' : ''; ?>
									 </div>
                 					 </div>
