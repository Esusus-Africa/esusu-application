...
if(isset($_POST['save']))
{
  ...
  $result = json_decode($make_call, true);
    ...
    if($result['status'] == "success"){
      ...
      $insert = mysqli_query($link, "INSERT INTO transfer_recipient VALUES(null,'','$recipient_id','$fullname','$account_number','$bank_code','$bank_name',NOW())") or die ("Error: " . mysqli_error($link));
