<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="newsboard.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDE1"><button type="button" class="btn btn-flat bg-red"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> <i class="fa fa-signal"></i>  Add Notice</h3>
            </div>
...
?>           
			...
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Caption (Headline)</label>
                  <div class="col-sm-10">
            ...
            <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Details</label>
                  <div class="col-sm-10">
              ...
              <div class="box-footer">
                				...
                				<button name="submit" type="submit" class="btn bg-blue btn-flat"><i class="fa fa-add">&nbsp;Submit</i></button>
