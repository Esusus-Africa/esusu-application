...
if(isset($_POST['save']))
{
	...
	$amount_incomm = mysqli_real_escape_string($link, $_POST['amount_incomm']);
	$amount_tocashout =  mysqli_real_escape_string($link, $_POST['amount_tocashout']);
	...
	if($amount_incomm < $amount_tocashout){
		...
		$insert = mysqli_query($link, "INSERT INTO fund_settlement VALUES(null,'$companyid','$mbranchid','$teller','$mycashier_id','$currency','$amount_tocashout','$remaining_balance','$note_comment',NOW())") or die ("Error: " . mysqli_error($link));

		$update_till = mysqli_query($link, "UPDATE till_account SET commission_balance = '$remaining_balance' WHERE cashier = '$mycashier_id'") or die ("Error: " . mysqli_error($link));

		if(!($insert && $update_till))
		{
			echo "<div class='alert bg-orange'>Unable to Withdraw Commission.....Please try again later</div>";
		}
		else{
...
?>           
            ...
            <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:blue;">Commission Balance</label>
                  <div class="col-sm-9">
            ...
            <div class="form-group">
                  <label for="" class="col-sm-3 control-label" style="color:blue;">Amount to Cashout</label>
                  <div class="col-sm-9">
            ...
            <div class="form-group">
              ...
              <div class="box-footer">
                <button name="save" type="submit" class="btn bg-blue"><i class="fa fa-save">&nbsp;Withdrawal</i></button>
              </div>
			  </div>
