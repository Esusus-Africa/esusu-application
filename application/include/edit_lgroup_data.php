<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="list_lgroup.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("411"); ?>&&mid=NDEx"><button type="button" class="btn bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-newspaper-o"></i> Edit Group Settings</h3>
            </div>
