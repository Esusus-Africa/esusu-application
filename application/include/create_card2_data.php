	 ...
	 <section class="content">
		 ...
		 <div class="col-md-14">
            ...
            <ul class="nav nav-tabs">
             <li <?php echo ($_GET['tab'] == 'tab_1') ? "class='active'" : ''; ?>><a href="create_card2.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("550"); ?>&&tab=tab_1">Card Enrollment Form</a></li>
             <li <?php echo ($_GET['tab'] == 'tab_2') ? "class='active'" : ''; ?>><a href="#create_card2.php?id=<?php echo $_SESSION['tid']; ?>&&mid=<?php echo base64_encode("550"); ?>&&tab=tab_2">View Card</a></li>
              </ul>
...
if(isset($_GET['tab']) == true)
{
	...
	?>
			 ...
			 <form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_card2.php">
             <div class="box-body">
            ...
            <div class="form-group">
				...
				<select name="customer"  class="form-control select2" required>
						<option value='' selected='selected'>Select Cooperative&hellip;</option>
										<?php
$search = mysqli_query($link, "SELECT * FROM cooperatives ORDER BY id DESC");
