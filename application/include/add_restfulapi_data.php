...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO restful_apisetup VALUES(null,'$api_name','$api_url')") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
		echo "<div class='alert bg-orange'>Unable to Create RESTful API.....Please try again later</div>";
	}
	else{
...
?>           
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input name="api_name" type="text" class="form-control" placeholder="e.g balance, transfer, subaccount, etc." required>
