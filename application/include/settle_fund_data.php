...
if(isset($_POST['save']))
{
	...
	$insert = mysqli_query($link, "INSERT INTO fund_settlement VALUES(null,'$companyid','$mbranchid','$teller','$cashier','$currency','$amount_tosettle','$balance','$note_comment',NOW())") or die ("Error: " . mysqli_error($link));
	if(!$insert)
	{
...
?>           
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9">
                  <input name="amount_tosettle" type="text" class="form-control" placeholder="Enter Amount to Allocate to the Cashier" required>
                  </div>
                  </div>
