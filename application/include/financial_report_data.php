...
$select = mysqli_query($link, "SELECT SUM(amount_paid) FROM saas_subscription_trans WHERE duration_from BETWEEN '$dfrom' AND '$dto' AND status = 'Paid' ORDER BY id") or die (mysqli_error($link));
					...
					while($fetch4 = mysqli_fetch_array($select4))
					{
						...
						while($fetch5 = mysqli_fetch_array($select5))
						{
							...
							while($fetch6 = mysqli_fetch_array($select6))
							{
								...
								$select7 = mysqli_query($link, "SELECT SUM(amount) FROM referral_incomehistory WHERE tdate BETWEEN '$dfrom' AND '$dto'");
...
?>
				...
				<tr>
			  	...
			  	<tr>
					...
					<td><div align="right"><?php echo number_format($total_subacctcharge,2,'.',','); ?></div></td>
			  	...
			  	<tr>
					<td><div align="left">Amount Charged per Account / ATM Card Validation [Authorization Charges]</div></td>
					<td><div align="right"><?php echo number_format($totalauth_charges,2,'.',','); ?></div></td>
			  	...
			  	<tr>
					...
					<td><div align="right"><b style="font-size: 20px;"><?php echo number_format($total_expenses,2,'.',','); ?></b></div></td>
			  	</tr>
			  	<tr>
					...
					<td><div align="right"><b style="font-size: 18px;"><?php echo ($total_prAndloss <= 0) ? $total_prAndloss : '----------'; ?></b></div></td>
			  	</tr>
			  	<tr>
					<td><div align="left">Others</div></td>
			  	...
			  	<tr>
					...
					<td><div align="right"><b style="font-size: 20px;"><?php echo number_format($total_income,2,'.',','); ?></b></div></td>
					<td><div align="left"></div></td>
					<td><div align="right"></div></td>
			  	</tr>
			  	<?php
			  	...
			  	<tr>
					...
					<td><div align="right"><b style="font-size: 18px;"><?php echo number_format($total_prAndloss,2,'.',','); ?></b></div></td>
					<td><div align="left"></div></td>
					<td><div align="right"></div></td>
			  	</tr>
			  <?php } ?>
...
{
	echo "<script>window.open('../pdf/view/pdf_financial.php?dfrom=".$dfrom."&&dto=".$dto."', '_blank'); </script>";
}
?>
