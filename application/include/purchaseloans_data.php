<div class="box">
	       ...
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-money"></i>&nbsp;Purchase Loans</h3>
            </div>
             <div class="box-body">
			...
			<div class="form-group">
				...
				<option value="" selected="selected">--Select Loan Product--</option>
	                <?php
					$getin = mysqli_query($link, "SELECT * FROM loan_product WHERE category = 'Purchase' ORDER BY id") or die (mysqli_error($link));
		...
		<div class="form-group">
              ...
              <input name="unumber" type="text" id="unumber" onkeydown="loaddata();" class="form-control" placeholder="BVN Number Here" maxlength="11">
			   <div id="bvn2"></div><br>
              </div>
              </div>
		...
		<div class="form-group">
                ...
                <div class="col-sm-10">
                <input name="income" type="text" class="form-control"  placeholder="Enter Your Income">
                </div>
                </div>
...
<hr>	
<div class="bg-orange">&nbsp;PRODUCT INFORMATION</div>
<hr>
				  
			<div class="form-group">
				<label for="" class="col-sm-2 control-label" style="color:blue;">Product Invoice</label>
				<div class="col-sm-10">
  		  		<input type='file' name="image" class="alert bg-orange">
			</div>
			</div>
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="pname" type="text" class="form-control" placeholder="Enter Product Name" required>
                  </div>
                  </div>
			
			<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:blue;">Model Number</label>
                  <div class="col-sm-10">
                  <input name="mno" type="text" class="form-control" required placeholder = "Enter Model Number / Engine Number">
                  </div>
                  </div>

            <div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:blue;">Serial Number</label>
                  <div class="col-sm-10">
                  <input name="sno" type="text" class="form-control" required placeholder = "Enter Serial Number">
                  </div>
                  </div>
            ...
            <div class="form-group">
                  	<label for="" class="col-sm-2 control-label" style="color:blue;">Other Description</label>
                  	<div class="col-sm-10">
					<textarea name="others"  class="form-control" rows="2" cols="80"></textarea>
           			 </div>
          	</div>
