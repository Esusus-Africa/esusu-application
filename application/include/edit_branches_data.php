<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="listbranches.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NDAy"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-object-ungroup"></i>  Edit Branch</h3>
            </div>
...
?>           
			...
			<div class="form-group">
                  ...
                  <input name="bname" type="text" class="form-control" placeholder="Branch Name Here" value="<?php echo $row['bname']; ?>" required>
				   <span style="color: blue;"> You can enter your branch name here e.g Branch #1, Branch #2 etc.</span><br>
                  </div>
                  </div>
		...
		<div class="form-group">
             ...
             <div class="form-group">
						<label for="" class="col-sm-2 control-label" style="color:blue;">Branch Stamp</label>
						<div class="col-sm-10">
								 ...
								 <br><img id="blah"  src="../image/<?php echo $row['stamp']; ?>" alt="Branch Stamp Here" height="100" width="100"/>
						</div>
						</div>
