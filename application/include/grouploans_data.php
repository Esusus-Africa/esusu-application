<div class="box">
	       ...
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-money"></i>&nbsp;Group Loans</h3>
            </div>
             <div class="box-body">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label" style="color:blue">Group</label>
				 <div class="col-sm-10">
				...
				<?php
				$get = mysqli_query($link, "SELECT * FROM lgroup_setup  order by id") or die (mysqli_error($link));
			...
			<div class="form-group">
				...
				<option value="" selected="selected">--Select Loan Product--</option>
	                <?php
					$getin = mysqli_query($link, "SELECT * FROM loan_product WHERE category = 'Group' ORDER BY id") or die (mysqli_error($link));
