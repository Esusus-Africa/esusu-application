<div class="box">
	       <div class="box-body">
            ...
            <h3 class="panel-title"> <a href="list_category.php?id=<?php echo $_SESSION['tid']; ?>&&mid=NzUw&&tab=tab_1"><button type="button" class="btn btn-flat bg-orange"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button></a> <i class="fa fa-code"></i>  Update Category</h3>
            </div>
...
if(isset($_POST['save']))
{
	...
	$update = mysqli_query($link, "UPDATE campaign_category SET category = '$cat' WHERE id = '$idm'") or die ("Error: " . mysqli_error($link));
	if(!$update)
	{
...
<?php
$idm = mysqli_real_escape_string($link, $_GET['idm']);
$search_cat = mysqli_query($link, "SELECT * FROM campaign_category WHERE id = '$idm'");
