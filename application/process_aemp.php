...
echo "<script>alert('The 2 Password does not match!'); </script>";
	...
	$insert = mysqli_query($link, "INSERT INTO user VALUES(null,'$name','$email','$phone','$addr1','$addr2','$city','$state','$zip','$country','','$username','$encrypt','$id','$location','$final_role','','Registered','$session_id','AG','0000','0.0')") or die (mysqli_error($link));
