      ...
      <div class="box">
          ...
          ?>
            <div class="box-header bg-blue" align="center">
              <h3 class="box-title"><?php echo ($fetcUNum == 1 && $fetcBNum == 0) ? $fetchUser['name'].' '.$fetchUser['lname'].' '.$fetchUser['mname'] : $fetchBorrower['fname'].' '.$fetchBorrower['lname']; ?></h3>
            </div>
	         <div class="box-body">
             ...
             <div class="box-body">
	           ...
	           <div class="form-group">
                ...
                <input name="filter_by" id="filterBy" type="hidden" class="form-control" value="<?php echo $_GET['aid']; ?>"/>
