...
if(isset($_POST['FundWallet']) && ($fetchsys_config['mo_status'] == "NotActive"))
{
	...
	$redirect_url = 'https://app.esusu.africa/application/mywallet.php?id='.$_SESSION['tid'].'&&o_amt='.$secure_amount.'&&refid='.$reference.'&&mid=NDA0';
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_POSTFIELDS => json_encode([
        ...
        'paymentDescription'=>'Fund My Wallet',
