...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pool Account</li>
      </ol>
    </section>
	
    <section class="content">
		<?php 
      include("include/all_poolAcct_data.php");
    ?>
	</section>
</div>
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
  ...
  var dataTable = $('#fetch_allpoolacct_data').DataTable({
   "processing" : true,
   "serverSide" : true,
   'serverMethod': 'post',
   "ajax" : {
    url:"fetch_allpoolacct_report.php",
    'data': function(data){
        // Read values
