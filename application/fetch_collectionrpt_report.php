...
$column = array('id', 'Reference ID', 'Client Name', 'Client Branch', 'Client Vendor', 'Staff/Sub-Agent', 'Loan ID', 'Loan Product', 'Borrowers Name', 'Amount Paid', 'Loan Balance', 'Pay Date', 'Status');
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy != "all"){
    ...
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND remarks = 'paid' AND (branchid = '$filterBy' OR sbranchid = '$filterBy' OR vendorid = '$filterBy' OR tid = '$filterBy' OR account_no = '$filterBy')
    ";
...
if($startDate != "" && $endDate != "" && $filterBy != "" && $filterBy === "all"){
    ...
    $query .= "SELECT * FROM payments 
    WHERE pay_date BETWEEN '$startDate' AND '$endDate' AND remarks = 'paid'
    ";
