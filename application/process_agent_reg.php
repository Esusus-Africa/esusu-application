...
if(isset($_POST['save']))
{
	...
	$insert_agent = mysqli_query($link, "INSERT INTO agent_data VALUES(null,'$agentid','$agenttype','$fname','$gender','$dob','$bname','$rcnumber','$occupation','','$email','$phone','$username','$password','','$location','','','Pending','agent_manager','0.0','$wprefund_bal','NULL',NOW(),'')") or die ("Error: " . mysqli_error($link));
    ...
    $insert_agent = mysqli_query($link, "INSERT INTO maintenance_history VALUE(null,'$agentid','2.5','','flat','5','2000','Activated')") or die ("Error: " . mysqli_error($link));
	$insert = mysqli_query($link, "INSERT INTO member_settings VALUE(null,'$agentid','$bname','img/','','$my_senderid','$currency_type','','','','','100000')") or die ("Error: " . mysqli_error($link));
		...
		$sms = "$r->abb>>>Welcome $fname! Agent ID: $my_senderid, Username: $username, Password: $password, Transaction Pin: 0000. Login here: https://esusu.app/$my_senderid";
