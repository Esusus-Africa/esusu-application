          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info" style="border-style: none inset solid inset;">
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                <h4><b style="color: blue;">BASIC INFO:</b><img src="<?php echo $fetchsys_config['file_baseurl']; ?>down-arrow-new.gif" width="30px" height="30px"></h4>
                <address>
                    <table>
                    <tr>
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                <h4><b style="color: blue;">OTHER DETAILS:</b><img src="<?php echo $fetchsys_config['file_baseurl']; ?>down-arrow-new.gif" width="30px" height="30px"></h4>
                <address>
                    <table>
                    <tr>
            ...
            <div class="box-footer">
	            ...
	            <button type="button" onClick="window.print();" class="btn bg-orange pull-right" ><i class="fa fa-print"></i>Print</button>;
                 ...
                 <?php echo ($userUpgradeStatus == "Verified") ? '' : '<a href="upgradeWallet.php?id='.$_SESSION['tid'].'&&mid=NDA0&&uid='.$acctOwnerID.'" target="_blank"><button type="button" class="btn bg-blue pull-right" ><i class="fa fa-info"></i>Review Account</button></a>'; ?>
            ...
            if(mysqli_num_rows($searchComment) == 0){
                ...
                echo "<span style='color: orange'>No Comment!!</span>";
