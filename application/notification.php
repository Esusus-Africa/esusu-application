...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Payment Notification for all Products
    ...
    <section class="content">
		<?php include("include/notification_data.php"); ?>
	</section>
</div>	
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
  ...
  var dataTable = $('#fetch_allnotification_data').DataTable({
   "processing" : true,
   "serverSide" : true,
   'serverMethod': 'post',
   "ajax" : {
    url:"fetch_allnotification_report.php",
    'data': function(data){
        // Read values
