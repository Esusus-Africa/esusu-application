...
if($filterBy != "" && $filterBy === "all"){
    ...
    WHERE virtual_acctno != '' AND card_id != 'NULL' AND card_reg = 'Yes'
    ";
...
if($filterBy != "" && $filterBy != "all"){
    ...
    $query .= "SELECT * FROM borrowers 
    WHERE (account = '$filterBy' OR branchid = '$filterBy')
    ";
...
{
 $query = "SELECT * FROM borrowers WHERE virtual_acctno != '' AND card_id != 'NULL' AND card_reg = 'Yes'";
 $statement = $connect->prepare($query);
 $statement->execute();
