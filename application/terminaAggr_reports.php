...
<div class="content-wrapper">
    ...
    <section class="content">
		<?php include("include/terminaAggr_reports_data.php"); ?>
	</section>
</div>
...
<script type="text/javascript" language="javascript">
 $(document).ready(function(){
  ...
  var dataTable = $('#fetch_terminalAggr_data').DataTable({
   "processing" : true,
   "serverSide" : true,
   'serverMethod': 'post',
   "ajax" : {
    url:"fetch_terminalAggr_report.php",
    'data': function(data){
        // Read values
