...
$message2 .= "Welcome $emapData[2]! ";
$message2 .= "Your Coopperative Registration has been initiated successfully on our platform. ";
$message2 .= "Kindly wait patiently for us to setup your individual account. Thanks.";
$debug = true;

ozekiSend($sender,$emapData[7],$message2,$debug);
}
else{
	echo "";
}
