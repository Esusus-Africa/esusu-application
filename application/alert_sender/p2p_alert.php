...
$tmode = ($ptype == "p2p-transfer" ? "CR" : ($ptype == "p2p-reversal" ? "REV" : "DR"));

$message = "$sys_abb>>>$tmode";
$message .= " Amt: ".$currency.$amt."";
$message .= " Acc: ".$accno."";
$message .= " Desc: ".$ptype." - | ".$txid."";
$message .= " Time: ".$correctdate."";
$message .= " Bal: ".$currency.number_format($totalwallet_balance,2,'.',',')."";
$debug = true;
