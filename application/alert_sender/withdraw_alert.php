...
$message = "$sys_abb>>>DR";
$message .= " Amt: ".$sys_currency.number_format($amount,2,'.',',')."";
$message .= " Acc: ".$accno."";
$message .= " Desc: ".$remark." - ".$ln." | ".$txid."";
$message .= " Time: ".$time."";
$message .= " Bal: ".$sys_currency.number_format($semi_total,2,'.',',')."";
$debug = true;
ozekiSend($sender,$phone,$message,$debug);

//DEBIT ALERT FOR WITHDRAWAL FEE
$message = "$sys_abb>>>DR (Withdrawal Charges)";
$message .= " Amt: ".$sys_currency.number_format($final_charges,'.',',')."";
$message .= " Acc: ".$accno."";
$message .= " Desc: Charges - ".$ln." | ".$txid."";
$message .= " Time: ".$time."";
$message .= " Bal: ".$sys_currency.number_format($total,2,'.',',')."";
$debug = true;
ozekiSend($sender,$phone,$message,$debug);
