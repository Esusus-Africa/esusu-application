...
if($_SERVER['REQUEST_METHOD'] === "GET") {
    ...
    $resultsData = ((isset($_GET['id'])) && ($_GET['id'] != "")) ? $savings->fetchCardTransactionStatus($_GET['id'],$clientId,$companyName,$aggrId,$iwallet_balance) : "Invalid Request";
    ...
    }else if($resultsData === -1){
        
        $newhttp->notFound('Invalid Transaction Request');
