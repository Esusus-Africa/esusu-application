...
if($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $results = $user->createAuth($authReceived,$registeral,$companyName,$reg_fName,$reg_lName,$reg_mName,$tillBalance,$tillCommission,$tillCommissionType,$myimage,$reg_staffid);
    ...
    if($resultsInfo === -1) {
        ...
        $http->notAuthorized('Oops! You are not Authorized to use this facilities.');
