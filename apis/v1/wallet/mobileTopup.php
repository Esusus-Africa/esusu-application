...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $aTReceived = json_decode(file_get_contents("php://input"));
    
    $wallet = new Wallet($db);

    $results = $wallet->buyAirtime($aTReceived, $registeral, $companyName, $reg_staffid, $mytpin, $reg_mEmail, $reg_fName, $reg_lName, $availableWalletBal);
