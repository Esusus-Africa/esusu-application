...
if($_SERVER['REQUEST_METHOD'] === "GET") {
    ...
    $resultsData = (isset($_GET['id'])) ? $savings->fetchTransById($_GET['id'],$registeral,$companyName) : $savings->fetchAllTrans($registeral,$companyName,$irole,$reg_staffid,$reg_branch);
