...
if($_SERVER['REQUEST_METHOD'] === "GET") {
    ...
    //FETCH WITHDRAWAL CHARGES BY LIMIT IF ID EXIST OR ALL IF ID DOESN'T EXIST
    $resultsData = (isset($_GET['id'])) ? $savings->fetchWithdrawChargesByLimit($registeral,$_GET['id']) : $savings->fetchAllWithdrawCharges($registeral);
