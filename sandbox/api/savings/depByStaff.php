...
if($_SERVER['REQUEST_METHOD'] === "GET") {
    ...
    //FETCH DEPOSIT MADE BY STAFF IF ID EXIST OR NONE IF ID DOESN'T EXIST
    $resultsData = (isset($_GET['id'])) ? $user->fetchDepositByStaff($_GET['id'], $registeral) : "Parameter is Required";
